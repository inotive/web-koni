<?php $__env->startSection('pageTitle', 'ESI - Esports'); ?>
...
<?php $__env->startSection('currentSection', 'ESI - Esports'); ?>
        ...
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap py-5">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                    ...
                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                        <a href="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi.esi.create')); ?>" class="btn custom-red-button"
                        ...
                        <div class="dropdown-menu p-3 shadow" style="min-width: 320px;">
                            <div class="mb-3">
                                ...
                                <select id="filter-jenis-kegiatan" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $esiData->pluck('nama_kegiatan')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card-body position-relative">
                ...
                <div id="table-container">
                    <?php echo $__env->make('admin.laporan-lpj.bidang.prestasi.akurasi.esi._table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
        ...
        $('#submitBtnDelete').on('click', function() {
            ...
            const url = "<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi.esi.destroy', ':id')); ?>".replace(':id', deleteId);
        ...
        function deleteItemWithSwal(itemId, itemName = 'item ini') {
            const url = "<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi.esi.destroy', ':id')); ?>".replace(':id', itemId);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/prestasi/Akurasi/esi/index.blade.php ENDPATH**/ ?>