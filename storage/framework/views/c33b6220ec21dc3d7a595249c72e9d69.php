...
<html>
<head>
    <title>Laporan LPJ - <?php echo e($kegiatanLainnya->nama_program); ?> - Kegiatan Lainnya</title>
    <meta charset="UTF-8">
    <style>
       @page {
                        ...
                        <div class="mb-3">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="d-flex align-items-center p-2 border rounded bg-white">
                                    ...
                                    <a href="<?php echo e(storage_path('app/public/' . $path)); ?>"
                                       target="_blank"
                        ...
                        <?php $__currentLoopData = $kegiatanLainnya->dokumen_lpj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dokumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($path && file_exists(storage_path('app/public/' . $path))): ?>
                                <div class="d-flex align-items-center p-2 border rounded bg-light">
                                    <i class="<?php echo e($iconClass); ?> me-3" style="font-size: 1.2em;"></i>
                                    <div class="flex-grow-1">
                                        <div class="fw-medium text-dark"><?php echo e($originalName); ?></div>
