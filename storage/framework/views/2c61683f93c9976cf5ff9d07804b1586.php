...
<body>
    <div class="export-container">
        <div class="export-header">
            ...
            <p class="export-date">Tanggal: <?php echo e(date('d F Y')); ?></p>
        </div>
                    ...
                    <div class="progress w-100" style="height: 35px;">
                        ...
                        <div class="position-absolute w-100 h-100 d-flex justify-content-between align-items-center px-2" style="top: 0; left: 0; pointer-events: none;">
                            <span class="fw-bold" style="color: #151D48; text-shadow: 0 0 2px rgba(255,255,255,0.3);">
                                Rp <?php echo e(number_format($display_serapan, 0, ',', '.')); ?> / Rp <?php echo e(number_format($display_budget, 0, ',', '.')); ?>
        ...
        <div class="mt-4 text-muted">
            <p><small>Dokumen ini dihasilkan pada <?php echo e(date('d F Y H:i:s')); ?></small></p>
        </div>
    </div>
</body>
</html><?php /**PATH /home/thur/Documents/Inotive/web-koni/resources/views/admin/dashboard/export.blade.php ENDPATH**/ ?>