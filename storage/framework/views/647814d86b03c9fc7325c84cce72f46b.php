<?php $__env->startSection('pageTitle', 'Edit Prestasi'); ?>
...
<?php $__env->startSection('currentSection', 'Edit Prestasi'); ?>
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo e(route('admin.konfigurasi.prestasi.update', $prestasi->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control"
                                        value="<?php echo e($prestasi->subject->nama); ?> (Atlet)"
                                        readonly>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('kejuaraan', $prestasi->kejuaraan)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('nama_prestasi', $prestasi->nama_prestasi)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="cabor_id"
                                        ...
                                        <?php $__currentLoopData = $cabors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cabor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($cabor->id); ?>"
                                                <?php if($effectiveCaborId == $cabor->id): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php if(!$prestasi->cabor_id && $prestasi->subject->cabor_id): ?>
                                        <div class="form-hint mt-1" style="color: #fd7e14;">
                                            <i class="fas fa-info-circle"></i>
                                            Catatan: Saat ini menggunakan cabang olahraga dari <?php echo e(class_basename($prestasi->subject_type)); ?>.
...
unset($__errorArgs, $__bag); ?>" id="tingkat"
                                        ...
                                        <option value="Sekolah" <?php if(old('tingkat', $prestasi->tingkat) == 'Sekolah'): echo 'selected'; endif; ?>>Sekolah</option>
                                        <option value="Kecamatan" <?php if(old('tingkat', $prestasi->tingkat) == 'Kecamatan'): echo 'selected'; endif; ?>>Kecamatan</option>
                                        <option value="Kabupaten/Kota" <?php if(old('tingkat', $prestasi->tingkat) == 'Kabupaten/Kota'): echo 'selected'; endif; ?>>Kabupaten/Kota</option>
                                        <option value="Provinsi" <?php if(old('tingkat', $prestasi->tingkat) == 'Provinsi'): echo 'selected'; endif; ?>>Provinsi</option>
                                        <option value="Nasional" <?php if(old('tingkat', $prestasi->tingkat) == 'Nasional'): echo 'selected'; endif; ?>>Nasional</option>
                                        <option value="Internasional" <?php if(old('tingkat', $prestasi->tingkat) == 'Internasional'): echo 'selected'; endif; ?>>Internasional</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        id="tempat" name="tempat" value="<?php echo e(old('tempat', $prestasi->tempat)); ?>"
                                        required>
...
unset($__errorArgs, $__bag); ?>"
                                        id="tahun" name="tahun" value="<?php echo e(old('tahun', $prestasi->tahun)); ?>"
...
unset($__errorArgs, $__bag); ?>" id="medali"
                                        ...
                                        <option value="Emas" <?php if(old('medali', $prestasi->medali) == 'Emas'): echo 'selected'; endif; ?>>Emas</option>
                                        <option value="Perak" <?php if(old('medali', $prestasi->medali) == 'Perak'): echo 'selected'; endif; ?>>Perak</option>
                                        <option value="Perunggu" <?php if(old('medali', $prestasi->medali) == 'Perunggu'): echo 'selected'; endif; ?>>Perunggu</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            const selectedValue = "<?php echo e(old('cabor_id', $prestasi->cabor_id ?? $prestasi->subject->cabor_id ?? '')); ?>";
            if (selectedValue) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thur/Documents/Inotive/web-koni/resources/views/admin/prestasi/edit.blade.php ENDPATH**/ ?>