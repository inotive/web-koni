                ...
                <?php
                    $percentage =
                        $target && $target->target_anggaran > 0
                            ...
                            : 0;
                ?>
                <h1 class="mb-1 fw-bold"><?php echo e(formatRupiah($current_budget)); ?> /
                    <?php echo e(formatRupiah($target->target_anggaran ?? 0)); ?></h1>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        `);
                ...
                function updateTable(params = {}) {
                    return new Promise((resolve, reject) => {
                        ...
                        let baseUrl = parentId ?
                            "<?php echo e(route('admin.laporan-lpj.bidang.dynamic.child.index', ':parentId')); ?>".replace(
                                ':parentId', parentId) :
                ...
                window.deleteItemWithSwal = function(itemId, itemName = 'item ini') {
                    const url = "<?php echo e(route('admin.laporan-lpj.bidang.dynamic.destroy', ':id')); ?>".replace(':id',
                        itemId);
    ...
    data - title = "Dokumen LPJ" >
        ...
        $('#export-pdf-btn').on('click', function(e) {
            ...
            if (lpjId) {
                let exportUrl = "<?php echo e(route('admin.laporan-lpj.bidang.dynamic.export-pdf', ':id')); ?>".replace(':id',
                    lpjId);
