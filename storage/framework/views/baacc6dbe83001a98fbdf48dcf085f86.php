<?php $__env->startSection('pageTitle', 'Edit Laporan Bendahara'); ?>
<?php $__env->startSection('mainSection', 'Bendahara'); ?>
<?php $__env->startSection('mainSectionUrl', route('admin.bendahara.index')); ?>
<?php $__env->startSection('subSection', 'Laporan'); ?>
<?php $__env->startSection('subSectionUrl', route('admin.bendahara.index')); ?>
<?php $__env->startSection('currentSection', 'Edit Laporan Bendahara'); ?>
...
<div class="d-flex justify-content-between align-items-center flex-wrap mb-4" style="padding: 20px 20px">
    <h3 class="fw-bold fs-2 mb-0 text-dark">Edit Laporan Bendahara</h3>
</div>
        ...
        <div class="row">
            <div class="card card-form">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="<?php echo e(route('admin.bendahara.update', $laporanBendahara->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('judul', $laporanBendahara->judul)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row align-items-start mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="current-file">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <i class="fas fa-file-alt current-file-icon me-2"></i>
                                            <div>
                                                <p class="mb-1 fw-medium">File saat ini:</p>
                                                <p class="mb-0 text-muted small"><?php echo e(basename($laporanBendahara->dokumen)); ?></p>
                                            </div>
                                        </div>
                                ...
                                <label for="dokumen" class="file-upload-wrapper" id="uploadContent">
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <div>
                                        <p class="file-upload-text mb-1" id="file-name-display">
                                            <?php echo e($laporanBendahara->dokumen ? 'Klik untuk mengubah dokumen' : 'Seret dan lepas file di sini, atau klik untuk mengunggah.'); ?>

                                        </p>
                                        <p class="file-upload-hint">
                                            <?php echo e($laporanBendahara->dokumen ? 'Kosongkan jika tidak ingin mengubah dokumen' : 'Format yang didukung: PDF, DOC, DOCX, XLS, XLSX'); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        uploadInput.addEventListener('change', function() {
            ...
            if (file) {
                ...
                fileNameDisplay.textContent = '<?php echo e($laporanBendahara->dokumen ? "Klik untuk mengubah dokumen" : "Seret dan lepas file di sini, atau klik untuk mengunggah."); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thur/Documents/Inotive/web-koni/resources/views/admin/bendahara/OLD/edit.blade.php ENDPATH**/ ?>