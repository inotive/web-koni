                            ...
                            <div class="table-header" style="border-radius: 12px 12px 0px 0px">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <a href="<?php echo e(route('admin.konfigurasi.pelatih.export')); ?>" id="export-excel-btn"
                                ...
                                <?php if(!(isset($pelatih) && $pelatih->isEmpty())): ?>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div id="filter-info" class="text-muted">
                                            Menampilkan <span
                                                id="showing-count"><?php echo e(isset($pelatih) ? $pelatih->count() : 0); ?></span>
                                            dari <span id="total-count"><?php echo e(isset($pelatih) ? $pelatih->total() : 0); ?></span>
                                            pelatih
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gustibagus/Documents/GitHub/web-koni/resources/views/admin/pelatih/index.blade.php ENDPATH**/ ?>