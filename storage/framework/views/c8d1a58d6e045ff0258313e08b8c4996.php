<section class="bg-eerie-black text-white relative">
    <img class="absolute top-[-5%] right-0 w-[20rem] lg:w-fit"
        src="<?php echo e(asset('landing-assets/img/illustration/decoration/right.svg')); ?>" alt="decoration-right">
    <img class="absolute bottom-[-4%] left-0 w-[20rem] lg:w-fit"
        src="<?php echo e(asset('landing-assets/img/illustration/decoration/left.svg')); ?>" alt="decoration-left">
    ...
    <div class="container mx-auto px-4 lg:px-10">
        <div class="flex flex-col items-start lg:items-center lg:text-center gap-8 py-24">
            <div class="text-2xl lg:text-3xl lg:text-[42px] lg:leading-snug font-bold">
                <div class="text-Orange-Primary"><?php echo e(__('menu.cta.question')); ?></div>
                <div><?php echo e(__('menu.cta.ask')); ?></div>
            </div>
            <div class="text-base lg:text-xl">
                <?php echo e(__('menu.cta.description')); ?>
            ...
            <a href="<?php echo e(route('contact.index')); ?>"
                ...
                <div class="text-sm font-bold"><?php echo e(__('button.contact_us')); ?></div>
            </a>
        </div>
    </div>
</section>
<?php /**PATH /home/thur/Documents/Inotive/web-koni/resources/views/components/cta.blade.php ENDPATH**/ ?>