<?php $__env->startSection('title', 'Detail Cabang Olahraga'); ?>


<?php $__env->startSection('pageTitle', 'Detail ' . $cabor->nama_cabor); ?>
<?php $__env->startSection('mainSection', 'Konfigurasi'); ?>
<?php $__env->startSection('currentSection', 'Detail Cabang Olahraga ' . $cabor->nama_cabor); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-6">
            <div class="flex-shrink-0 me-3">
                <a href="<?php echo e(route('admin.konfigurasi.cabang-olahraga.index')); ?>" class="btn btn-light-primary">
                ...
                <h1 class="page-heading d-flex text-dark fw-bold fs-1 my-0 align-items-center justify-content-center justify-content-md-start">
                    ...
                    <?php if($cabor->icon_cabor): ?>
                        <div class="symbol symbol-40px me-3">
                            <img src="<?php echo e(asset('storage/' . $cabor->icon_cabor)); ?>" alt="<?php echo e($cabor->nama_cabor); ?>"
                                class="rounded">
                        </div>
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <span class="text-ellipsis">Detail <?php echo e($cabor->nama_cabor); ?></span>
                </h1>
                ...
                <div class="text-muted fs-6 mt-2 d-flex flex-wrap justify-content-center justify-content-md-start">
                    <span class="me-3 mb-1">
                        ...
                        <span class="text-ellipsis d-inline-block" style="max-width: 150px;">
                            PJ: <?php echo e($cabor->ketua_penanggung_jawab); ?>

                        </span>
                    </span>
                    <span class="me-3 mb-1">
                        <i class="ki-duotone ki-calendar fs-6 me-1"></i>
                        Dibentuk: <?php echo e(\Carbon\Carbon::parse($cabor->tanggal_pembentukan)->format('d M Y')); ?>

                    </span>
                    <span class="badge badge-<?php echo e($cabor->status === 'Aktif' ? 'success' : 'danger'); ?> mb-1">
                    ...
                    <div class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 overflow-auto flex-nowrap">
                        <div class="nav-item flex-shrink-0">
                            <a class="nav-link active fw-bold" data-bs-toggle="tab" href="#kt_tab_pane_atlet">
                                ...
                                <span class="badge badge-light-primary ms-2"><?php echo e($atlets->total() ?? 0); ?></span>
                            </a>
                        </div>
                        <div class="nav-item flex-shrink-0">
                            <a class="nav-link fw-bold" data-bs-toggle="tab" href="#kt_tab_pane_pelatih">
                                ...
                                <span class="badge badge-light-success ms-2"><?php echo e($pelatihs->total() ?? 0); ?></span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="kt_tab_pane_atlet" role="tabpanel">
                        <?php if($atlets->count() > 0): ?>
                                    ...
                                    <div class="d-flex justify-content-end align-items-center">
                                        <div class="d-flex align-items-center me-3 mb-2">
                                            ...
                                            <a href="<?php echo e(route('admin.konfigurasi.cabang-olahraga.export-atlet', $cabor->id)); ?>" 
                                               class="btn btn-success me-2" id="export-atlet-btn" title="Export Data Atlet ke Excel">
                                                <i class="fas fa-file-excel me-1"></i> Export Atlet
                                            </a>
                            ...
                            <div class="table-container">
                                <div class="table-responsive">
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gy-7 mb-0">
                                        <thead>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $atlets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $atlet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="ps-6">
                                                        <span class="text-gray-800 fw-bold">
                                                            <?php echo e(($atlets->currentPage() - 1) * $atlets->perPage() + $index + 1); ?>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <?php if($atlet->foto): ?>
                                                                <div class="symbol symbol-50px">
                                                                    <img src="<?php echo e(asset('storage/' . $atlet->foto)); ?>"
                                                                        alt="Foto <?php echo e($atlet->nama); ?>"
                                                    ...
                                                    <td>
                                                        <span class="text-gray-800 fw-bold text-ellipsis"><?php echo e($atlet->nama ?? '-'); ?></span>
                                                    </td>
                                                    <td>
                                                        <div class="text-gray-800 fw-semibold">
                                                            <div class="text-ellipsis"><?php echo e($atlet->tempat_lahir ?? '-'); ?></div>
                                                            <div class="text-muted fs-7">
                                                                <?php echo e(isset($atlet->tanggal_lahir) ? \Carbon\Carbon::parse($atlet->tanggal_lahir)->translatedFormat('d M Y') : '-'); ?>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge badge-light-info"><?php echo e(ucfirst($atlet->jenis_kelamin ?? '-')); ?></span>
                                                    </td>
                                                    <td>
                                                        <span class="text-gray-800 fw-semibold">
                                                            <?php echo e(isset($atlet->tanggal_lahir) ? \Carbon\Carbon::parse($atlet->tanggal_lahir)->age . ' th' : '-'); ?>

                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span class="text-gray-600 text-ellipsis">
                                                            <?php echo e(optional($atlet->prestasiTerbaru)->nama_prestasi ?? '-'); ?>

                                                        </span>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex flex-column">
                                                            <?php if($atlet->no_telepon): ?>
                                                                <span class="text-gray-800 fs-7 mb-1">
                                                                    <i class="ki-duotone ki-phone fs-6 me-1">
                                                                        <span class="path1"></span>
                                                                        <span class="path2"></span>
                                                                    </i>
                                                                    <?php echo e($atlet->no_telepon); ?>
                                                    ...
                                                    <td class="text-end pe-6">
                                                        <a href="<?php echo e(route('admin.konfigurasi.atlet.show', $atlet->id)); ?>?back=cabor&cabor_id=<?php echo e($cabor->id); ?>"
                            ...
                            <?php if($atlets->hasPages()): ?>
                                <div class="table-footer">
                                    <div class="d-flex justify-content-center">
                                        <?php echo e($atlets->appends(['pelatih_page' => $pelatihs->currentPage()])->links()); ?>
                        ...
                        <?php else: ?>
                            <div class="empty-state">
                                <img src="<?php echo e(asset('assets/media/illustrations/sketchy-1/2.png')); ?>" alt=""
                                    class="mw-400px">
                                <div class="pt-10 pb-10">
                                    <h2 class="fs-2 fw-bold text-gray-600">Belum Ada Atlet</h2>
                                    <p class="text-gray-400 fs-6 fw-semibold">
                                        Belum ada atlet yang terdaftar untuk cabang olahraga <?php echo e($cabor->nama_cabor); ?>.
                                    </p>
                                </div>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="tab-pane fade" id="kt_tab_pane_pelatih" role="tabpanel">
                        <?php if($pelatihs->count() > 0): ?>
                                    ...
                                    <div class="d-flex justify-content-end align-items-center">
                                        <div class="d-flex align-items-center me-3 mb-2">
                                            ...
                                            <a href="<?php echo e(route('admin.konfigurasi.cabang-olahraga.export-pelatih', $cabor->id)); ?>" 
                                               class="btn btn-success me-2" id="export-pelatih-btn" title="Export Data Pelatih ke Excel">
                                                <i class="fas fa-file-excel me-1"></i> Export Pelatih
                                            </a>
                            ...
                            <div class="table-container">
                                <div class="table-responsive">
                                    <table class="table table-row-dashed table-row-gray-300 gy-7 mb-0">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $pelatihs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pelatih): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="ps-6">
                                                        <span class="text-gray-800 fw-bold">
                                                            <?php echo e(($pelatihs->currentPage() - 1) * $pelatihs->perPage() + $index + 1); ?>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <?php if($pelatih->foto): ?>
                                                                <div class="symbol symbol-50px">
                                                                    <img src="<?php echo e(asset('storage/' . $pelatih->foto)); ?>"
                                                                        alt="Foto <?php echo e($pelatih->nama); ?>"
                                                                        class="rounded object-fit-cover">
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="symbol symbol-50px">
                                                    ...
                                                    <td>
                                                        <span class="text-gray-800 fw-bold text-ellipsis"><?php echo e($pelatih->nama ?? '-'); ?></span>
                                                    </td>
                                                    <td>
                                                        <div class="text-gray-800 fw-semibold">
                                                            <div class="text-ellipsis"><?php echo e($pelatih->tempat_lahir ?? '-'); ?></div>
                                                            <div class="text-muted fs-7">
                                                                <?php echo e(isset($pelatih->tanggal_lahir) ? \Carbon\Carbon::parse($pelatih->tanggal_lahir)->translatedFormat('d M Y') : '-'); ?>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge badge-light-info"><?php echo e(ucfirst($pelatih->jenis_kelamin ?? '-')); ?></span>
                                                    </td>
                                                    <td>
                                                        <span class="text-gray-800 fw-semibold">
                                                    ...
                                                    <td class="text-end pe-6">
                                                        <a href="<?php echo e(route('admin.konfigurasi.pelatih.show', $pelatih->id)); ?>?back=cabor&cabor_id=<?php echo e($cabor->id); ?>"
                                                            class="btn btn-sm btn-light-primary">
                            ...
                            <?php if($pelatihs->hasPages()): ?>
                                <div class="table-footer">
                                    <div class="d-flex justify-content-center">
                                        <?php echo e($pelatihs->appends(['atlet_page' => $atlets->currentPage()])->links()); ?>
                        ...
                        <?php else: ?>
                            <div class="empty-state">
                                ...
                                <div class="pt-10 pb-10">
                                    ...
                                    <p class="text-gray-400 fs-6 fw-semibold">
                                        Belum ada pelatih yang terdaftar untuk cabang olahraga <?php echo e($cabor->nama_cabor); ?>.
                                    </p>
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Javier\Documents\GitHub\web-koni\resources\views/admin/cabang-olahraga/show.blade.php ENDPATH**/ ?>