...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('tanggal_kegiatan', $kegiatanLainnya->tanggal_kegiatan ? $kegiatanLainnya->tanggal_kegiatan->format('Y-m-d') : '')); ?>">
                                    ...
                                    <?php if(count($dokumenLpjs) > 0): ?>
                                        <div class="existing-files-section">
                                            ...
                                            <div id="existing-dokumen-lpj-preview">
                                                <?php $__currentLoopData = $dokumenLpjs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dokumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        // Handle berbagai tipe data untuk dokumen
                                                        $path = '';
                                                        $originalName = '';
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            try {
                ...
                existingDokumenLpjFiles = <?php echo json_encode($kegiatanLainnya->dokumen_lpj_pdf ? (is_array($kegiatanLainnya->dokumen_lpj_pdf) ? $kegiatanLainnya->dokumen_lpj_pdf : [$kegiatanLainnya->dokumen_lpj_pdf]) : [], 15, 512) ?>;
            } catch (e) {
