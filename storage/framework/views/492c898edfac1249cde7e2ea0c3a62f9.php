<?php if($kegiatanLainnya->isEmpty()): ?>
    <?php if(request('search')): ?>
        ...
        <div class="text-center text-muted py-10">
            ...
            <h4>Data tidak ditemukan untuk pencarian "<?php echo e(request('search')); ?>"</h4>
        </div>
    <?php elseif(request('jenis_kegiatan_filter')): ?>
        
        <div class="text-center text-muted py-10">
            <i class="fas fa-filter fs-1 mb-3 text-muted"></i>
            <h4>Data tidak ditemukan untuk jenis kegiatan "<?php echo e(request('jenis_kegiatan_filter')); ?>"</h4>
            <button class="btn btn-light-primary mt-3"
                onclick="window.location.href='<?php echo e(route('admin.laporan-lpj.kegiatan-lainnya.index')); ?>'">
                Reset Filter
            </button>
        </div>
    <?php else: ?>
        ...
        <table class="table table-bordered table-hover align-middle table-fixed"
                        ...
                        <th class="text-start">
                            <?php if(($column['sortable'] ?? true) && $column['key']): ?>
                                <a href="<?php echo e(request()->fullUrlWithQuery([
                                    ...
                                    <?php if(request('sort_by') === $column['key']): ?>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $kegiatanLainnya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr data-jenis-kegiatan="<?php echo e($kegiatan->nama_kegiatan ?? ''); ?>"
                        data-tanggal="<?php echo e(\Carbon\Carbon::parse($kegiatan->tanggal_kegiatan ?? $kegiatan->created_at)->format('Y-m-d')); ?>">
                        ...
                        <td>
                            <div class="d-flex flex-column">
                                <strong class="text-truncate-custom" title="<?php echo e($kegiatan->nama_program); ?>">
                                    <?php echo e($kegiatan->nama_program); ?>
                        ...
                        <td class="text-start"><?php echo e($kegiatan->formatted_jumlah_harga_satuan); ?></td>

                        <td class="text-start"><?php echo e($kegiatan->formatted_jumlah_harga); ?></td>

                        <td class="text-start">
                            <?php if(!empty($kegiatan->foto_jurnal) && is_array($kegiatan->foto_jurnal)): ?>
                                <button type="button" class="btn btn-sm btn-light-info preview-btn"
                                    ...
                                    data-filenames="<?php echo e(json_encode(array_map('basename', $kegiatan->foto_jurnal))); ?>">
                        ...
                        <td class="text-start">
                            <?php if(!empty($kegiatan->dokumen_lpj) && is_array($kegiatan->dokumen_lpj)): ?>
                                <button type="button" class="btn btn-sm btn-light-primary preview-btn"
                                    ...
                                    data-filenames="<?php echo e(json_encode(array_map('basename', $kegiatan->dokumen_lpj))); ?>">
                                    <i class="fas fa-file-alt me-1"></i><?php echo e(count($kegiatan->dokumen_lpj)); ?> Dokumen
                                </button>
                            <?php else: ?>
                                <span class="text-muted">-</span>
                            <?php endif; ?>
                        ...
                        <td class="text-start">
                            <?php if(isset($kegiatan->is_approved) && $kegiatan->is_approved): ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php if(!auth()->user()->hasRole('superadmin') && 
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary mt-2 ajukan-perubahan-btn"
                                        data-kegiatan-id="<?php echo e($kegiatan->id); ?>"
                                        data-kegiatan-name="<?php echo e($kegiatan->nama_program); ?>">
                                        Ajukan Perubahan
                                    </button>
                                <?php endif; ?>
                            <?php endif; ?>
