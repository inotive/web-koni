...
<?php else: ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle" id="kt_datatable_dom_positioning_sumberdaya">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $abtiData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="text-center">
                            <?php echo e(($abtiData->currentPage() - 1) * $abtiData->perPage() + $index + 1); ?>
                            ...
                            <div class="dropdown dropdown-action" data-row-id="<?php echo e($data->id); ?>">
                                ...
                                <ul class="dropdown-menu dropdown-menu-custom">
                                    ...
                                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                                        <li>
                                            <a href="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-permainan.abti.edit', $data->id)); ?>"
    ...
    <div class="table-footer">
        <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            ...
            <?php if(isset($abtiData) && method_exists($abtiData, 'hasPages') && $abtiData->hasPages()): ?>
                <div class="d-flex align-items-center gap-3">
                    <div class="text-muted small">
                        <?php echo e($abtiData->firstItem()); ?>-<?php echo e($abtiData->lastItem()); ?> of
                        <?php echo e($abtiData->total()); ?>

                    </div>

                    <div class="d-flex align-items-center gap-2">
                        <?php if($abtiData->onFirstPage()): ?>
                            <span class="pagination-arrow disabled">←</span>
                        <?php else: ?>
                            <a href="<?php echo e($abtiData->appends(request()->query())->previousPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Previous">←</a>
                        <?php endif; ?>

                        <?php
                            $current = $abtiData->currentPage();
                            $total = $abtiData->lastPage();
                        ...
                        <div class="d-flex align-items-center">
                            <?php for($i = $start; $i <= $end; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($abtiData->appends(request()->query())->url($i)); ?>"
                                       class="pagination-number pagination-link"><?php echo e($i); ?></a>
                                <?php endif; ?>
                            <?php endfor; ?>
                        </div>

                        <?php if($abtiData->hasMorePages()): ?>
                            <a href="<?php echo e($abtiData->appends(request()->query())->nextPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Next">→</a>
                        <?php else: ?>
                            <span class="pagination-arrow disabled">→</span>
            ...
            <?php elseif(isset($abtiData) && method_exists($abtiData, 'hasPages')): ?>
                <div class="text-muted small">
                    1-<?php echo e($abtiData->count()); ?> of <?php echo e($abtiData->total()); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/prestasi/permainan/abti/_table.blade.php ENDPATH**/ ?>