...
<?php else: ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle" id="kt_datatable_dom_positioning_sumberdaya">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $porserosiData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="text-center">
                            <?php echo e(($porserosiData->currentPage() - 1) * $porserosiData->perPage() + $index + 1); ?>
                        ...
                        <td>
                            <div class="d-flex flex-column">
                                ...
                                <?php if($data->nama_kegiatan): ?>
                                    <small class="text-muted"><?php echo e($data->nama_kegiatan); ?></small>
                                <?php endif; ?>
                            </div>
                        </td>
                        ...
                        <td>
                            <?php if($data->foto_jurnal && count($data->foto_jurnal) > 0): ?>
                                <button type="button"
                                        ...
                                        data-type="image"
                                        data-files="<?php echo e(json_encode($data->foto_jurnal)); ?>"
                        ...
                        <td>
                            <?php if($data->dokumen_lpj && count($data->dokumen_lpj) > 0): ?>
                                <button type="button"
                                        ...
                                        data-bs-target="#previewModal"
                                        data-type="document"
                                        data-files="<?php echo e(json_encode($data->dokumen_lpj)); ?>"
                            ...
                            <div class="dropdown dropdown-action" data-row-id="<?php echo e($data->id); ?>">
                                ...
                                <ul class="dropdown-menu dropdown-menu-custom">
                                    ...
                                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                                        <li>
                                            <a href="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-terukur.porserosi.edit', $data->id)); ?>"
    ...
    <div class="table-footer">
        <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            <div class="mb-2 mb-md-0">
                <div class="d-flex align-items-center">
                    ...
                    <select name="per_page" class="form-select form-select-sm w-auto">
                        <?php $__currentLoopData = [10, 25, 50, 100]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lporserosit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($lporserosit); ?>"
                                <?php echo e(request('per_page', 10) == $lporserosit ? 'selected' : ''); ?>>
                                <?php echo e($lporserosit); ?>
            ...
            <?php if(isset($porserosiData) && method_exists($porserosiData, 'hasPages') && $porserosiData->hasPages()): ?>
                <div class="d-flex align-items-center gap-3">
                    <div class="text-muted small">
                        <?php echo e($porserosiData->firstItem()); ?>-<?php echo e($porserosiData->lastItem()); ?> of
                        <?php echo e($porserosiData->total()); ?>

                    </div>

                    <div class="d-flex align-items-center gap-2">
                        <?php if($porserosiData->onFirstPage()): ?>
                            <span class="pagination-arrow disabled">←</span>
                        <?php else: ?>
                            <a href="<?php echo e($porserosiData->appends(request()->query())->previousPageUrl()); ?>"
                        ...
                        <div class="d-flex align-items-center">
                            <?php for($i = $start; $i <= $end; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($porserosiData->appends(request()->query())->url($i)); ?>"
                                       class="pagination-number pagination-link"><?php echo e($i); ?></a>
                                <?php endif; ?>
                            <?php endfor; ?>
                        </div>

                        <?php if($porserosiData->hasMorePages()): ?>
                            <a href="<?php echo e($porserosiData->appends(request()->query())->nextPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Next">→</a>
                        <?php else: ?>
                            <span class="pagination-arrow disabled">→</span>
            ...
            <?php elseif(isset($porserosiData) && method_exists($porserosiData, 'hasPages')): ?>
                <div class="text-muted small">
                    1-<?php echo e($porserosiData->count()); ?> of <?php echo e($porserosiData->total()); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/prestasi/terukur/porserosi/_table.blade.php ENDPATH**/ ?>