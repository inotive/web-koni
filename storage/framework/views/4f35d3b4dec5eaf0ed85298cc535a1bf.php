...
<?php $__env->startSection('pageTitle', 'Pengguna'); ?>
<?php $__env->startSection('mainSection', 'Manajemen Pengguna'); ?>
<?php $__env->startSection('currentSection', 'Pengguna'); ?>
...
<?php $__env->startSection('content'); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr id="<?php echo e($value->id); ?>">
                                        ...
                                        <td class="text-start"><?php echo e($value->username); ?></td>
                                        <td class="text-center text-capitalize"><?php echo e($value->getRoleNames()->first()); ?></td>
                                        <td class="text-center"><?php echo e($value->email); ?></td>
                                        <td class="text-center">
                                            <?php echo e(\Carbon\Carbon::parse($value->created_at)->format('d/m/Y')); ?></td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#modalEditPengguna<?php echo e($value->id); ?>"
                                                    ...
                                                    <li>
                                                        <button
                                                            ...
                                                            data-route="<?php echo e(route('admin.manajemen-pengguna.pengguna.destroy', $value->id)); ?>">
    ...
    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo $__env->make('admin.user.component.modal', [
            'value' => $value,
            'roles' => $roles,
        ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('admin.user.component.modal-tambah', ['roles' => $roles], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/user/index.blade.php ENDPATH**/ ?>