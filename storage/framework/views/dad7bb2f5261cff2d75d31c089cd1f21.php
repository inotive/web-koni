<?php if($hubunganlembagaData->isEmpty()): ?>
...
<?php else: ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle" id="kt_datatable_dom_positioning_sumberdaya">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $hubunganlembagaData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="text-center">
                            <?php echo e(($hubunganlembagaData->currentPage() - 1) * $hubunganlembagaData->perPage() + $index + 1); ?>
                            ...
                            <div class="dropdown dropdown-action" data-row-id="<?php echo e($data->id); ?>">
                                ...
                                <ul class="dropdown-menu dropdown-menu-custom">
                                    ...
                                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                                        <li>
                                            <a href="<?php echo e(route('admin.laporan-lpj.bidang.hubungan-antar-lembaga.edit', $data->id)); ?>"
    ...
    <div class="table-footer">
        <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            ...
            <?php if(isset($hubunganlembagaData) && method_exists($hubunganlembagaData, 'hasPages') && $hubunganlembagaData->hasPages()): ?>
                <div class="d-flex align-items-center gap-3">
                    <div class="text-muted small">
                        <?php echo e($hubunganlembagaData->firstItem()); ?>-<?php echo e($hubunganlembagaData->lastItem()); ?> of
                        <?php echo e($hubunganlembagaData->total()); ?>

                    </div>

                    <div class="d-flex align-items-center gap-2">
                        <?php if($hubunganlembagaData->onFirstPage()): ?>
                            <span class="pagination-arrow disabled">←</span>
                        <?php else: ?>
                            <a href="<?php echo e($hubunganlembagaData->appends(request()->query())->previousPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Previous">←</a>
                        <?php endif; ?>

                        <?php
                            $current = $hubunganlembagaData->currentPage();
                            $total = $hubunganlembagaData->lastPage();
                        ...
                        <div class="d-flex align-items-center">
                            <?php for($i = $start; $i <= $end; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($hubunganlembagaData->appends(request()->query())->url($i)); ?>"
                                       class="pagination-number pagination-link"><?php echo e($i); ?></a>
                                <?php endif; ?>
                            <?php endfor; ?>
                        </div>

                        <?php if($hubunganlembagaData->hasMorePages()): ?>
                            <a href="<?php echo e($hubunganlembagaData->appends(request()->query())->nextPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Next">→</a>
                        <?php else: ?>
                            <span class="pagination-arrow disabled">→</span>
            ...
            <?php elseif(isset($hubunganlembagaData) && method_exists($hubunganlembagaData, 'hasPages')): ?>
                <div class="text-muted small">
                    1-<?php echo e($hubunganlembagaData->count()); ?> of <?php echo e($hubunganlembagaData->total()); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/hubungan-antar-lembaga/_table.blade.php ENDPATH**/ ?>