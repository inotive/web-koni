<?php $__env->startSection('pageTitle', 'Edit File'); ?>
<?php $__env->startSection('mainSection', 'File Kesekretariat'); ?>
<?php $__env->startSection('mainSectionUrl', route('admin.file-kesekretariat.index')); ?>
<?php $__env->startSection('currentSection', 'Edit File'); ?>
        ...
        <div class="row">
            <div class="card card-form">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form id="editFileForm" action="<?php echo e(route('admin.file-kesekretariat.update', $fileKesekretariat)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('nama_dokumen', $fileKesekretariat->nama_dokumen)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row align-items-start mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <?php if($fileKesekretariat->dokumen_file): ?>
                                <div class="current-file">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <?php
                                                $extension = pathinfo($fileKesekretariat->dokumen_file, PATHINFO_EXTENSION);
                                                $iconMap = [
                                                    'pdf' => 'fa-file-pdf',
                                                    'doc' => 'fa-file-word',
                                                    'docx' => 'fa-file-word',
                                            ...
                                            ?>
                                            <i class="fas <?php echo e($iconClass); ?> current-file-icon me-2"></i>
                                            <div>
                                                <p class="mb-1 fw-medium">File saat ini:</p>
                                                <p class="mb-0 text-muted small"><?php echo e($fileKesekretariat->dokumen_file); ?></p>
                                            </div>
                                        </div>
                                        <a href="<?php echo e(route('admin.file-kesekretariat.download', $fileKesekretariat)); ?>"
                                ...
                                <label for="dokumen_file" class="file-upload-wrapper" id="uploadContent">
                                    <input type="file" name="dokumen_file" id="dokumen_file"
                                           ...
                                           class="<?php $__errorArgs = ['dokumen_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <div>
                                        <p class="file-upload-text mb-1" id="file-name-display">
                                            <?php echo e($fileKesekretariat->dokumen_file ? 'Klik untuk mengubah dokumen' : 'Seret dan lepas file di sini, atau klik untuk mengunggah.'); ?>

                                        </p>
                                        <p class="file-upload-hint">
                                            <?php echo e($fileKesekretariat->dokumen_file ? 'Kosongkan jika tidak ingin mengubah dokumen' : 'Format yang didukung: PDF, DOC, DOCX, XLS, XLSX'); ?>

                                        </p>
                                    </div>
                                </label>

                                <?php $__errorArgs = ['dokumen_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-9 offset-md-3 d-flex justify-content-between">
                                <button type="submit" class="btn btn-danger px-4" id="submitBtn">Simpan Perubahan</button>
                                <a href="<?php echo e(route('admin.file-kesekretariat.index')); ?>" class="btn btn-secondary px-4">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        uploadInput.on('change', function() {
            ...
            if (file) {
                ...
                if (!allowedTypes.includes(fileExtension)) {
                    showNotification('Format file tidak didukung. Hanya diperbolehkan: PDF, DOC, DOCX, XLS, XLSX', 'error');
                    this.value = '';
                    return;
                }
                ...
                fileNameDisplay.textContent = '<?php echo e($fileKesekretariat->dokumen_file ? "Klik untuk mengubah dokumen" : "Seret dan lepas file di sini, atau klik untuk mengunggah."); ?>';
        ...
        $('#nama_dokumen').on('blur keyup', function() {
            ...
            if (value !== '<?php echo e(old("nama_dokumen", $fileKesekretariat->nama_dokumen)); ?>') {
                formDirty = true;
            }
        });
        ...
        $('#editFileForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "<?php echo e(route('admin.file-kesekretariat.index')); ?>";
                    }, 1500);
                },
                error: function(xhr) {
                    hideLoading();
                    ...
                    if (xhr.status === 422) {
                        ...
                        showNotification('Terdapat kesalahan pada form. Mohon periksa kembali.', 'error');
                    } else if (xhr.status === 413) {
                        showNotification('File terlalu besar. Silakan pilih file yang lebih kecil.', 'error');
                    } else {
                        // Network or server error
                        showNotification('Terjadi kesalahan jaringan. Silakan periksa koneksi internet Anda dan coba lagi.', 'error', 7000);
                    }
                }
            });
        });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/file-kesekretariat/edit.blade.php ENDPATH**/ ?>