<div class="row g-10">
    <?php $__empty_1 = true; $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <a href="<?php echo e(route('admin.laporan-lpj.bidang.dynamic.child.index', ['parentId' => $child->id, 'year' => $selectedYear])); ?>" class="col-12 col-sm-6 col-md-3">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-2">
                        <div class="d-flex justify-content-between mb-1">
                            <small class="fw-bold mb-1">Rp. <?php echo e(number_format($anggaran, 0, ',', '.')); ?> / Rp. <?php echo e(number_format($target_anggaran, 0, ',', '.')); ?></small>
                        </div>
                        <div class="progress" style="height: 8px; border-radius: 4px;">
                            <div class="progress-bar"
                                role="progressbar"
                                style="width: <?php echo e($percentage); ?>%; background-color: #F8285A;"
...
<?php /**PATH /home/thur/Documents/Inotive/web-koni/resources/views/admin/laporan-lpj/bidang/prestasi/Terukur/_table.blade.php ENDPATH**/ ?>