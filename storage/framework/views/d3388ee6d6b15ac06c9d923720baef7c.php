<?php if($pembinaanhukumData->isEmpty()): ?>
...
<?php else: ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle" id="kt_datatable_dom_positioning_sumberdaya">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $pembinaanhukumData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="text-center">
                            <?php echo e(($pembinaanhukumData->currentPage() - 1) * $pembinaanhukumData->perPage() + $index + 1); ?>
                            ...
                            <div class="dropdown dropdown-action" data-row-id="<?php echo e($data->id); ?>">
                                ...
                                <ul class="dropdown-menu dropdown-menu-custom">
                                    ...
                                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                                        <li>
                                            <a href="<?php echo e(route('admin.laporan-lpj.bidang.pembinaan-hukum.edit', $data->id)); ?>"
    ...
    <div class="table-footer">
        <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            ...
            <?php if(isset($pembinaanhukumData) && method_exists($pembinaanhukumData, 'hasPages') && $pembinaanhukumData->hasPages()): ?>
                <div class="d-flex align-items-center gap-3">
                    <div class="text-muted small">
                        <?php echo e($pembinaanhukumData->firstItem()); ?>-<?php echo e($pembinaanhukumData->lastItem()); ?> of
                        <?php echo e($pembinaanhukumData->total()); ?>

                    </div>

                    <div class="d-flex align-items-center gap-2">
                        <?php if($pembinaanhukumData->onFirstPage()): ?>
                            <span class="pagination-arrow disabled">←</span>
                        <?php else: ?>
                            <a href="<?php echo e($pembinaanhukumData->appends(request()->query())->previousPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Previous">←</a>
                        <?php endif; ?>

                        <?php
                            $current = $pembinaanhukumData->currentPage();
                            $total = $pembinaanhukumData->lastPage();
                        ...
                        <div class="d-flex align-items-center">
                            <?php for($i = $start; $i <= $end; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($pembinaanhukumData->appends(request()->query())->url($i)); ?>"
                                       class="pagination-number pagination-link"><?php echo e($i); ?></a>
                                <?php endif; ?>
                            <?php endfor; ?>
                        </div>

                        <?php if($pembinaanhukumData->hasMorePages()): ?>
                            <a href="<?php echo e($pembinaanhukumData->appends(request()->query())->nextPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Next">→</a>
                        <?php else: ?>
                            <span class="pagination-arrow disabled">→</span>
            ...
            <?php elseif(isset($pembinaanhukumData) && method_exists($pembinaanhukumData, 'hasPages')): ?>
                <div class="text-muted small">
                    1-<?php echo e($pembinaanhukumData->count()); ?> of <?php echo e($pembinaanhukumData->total()); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/pembinaan-hukum/_table.blade.php ENDPATH**/ ?>