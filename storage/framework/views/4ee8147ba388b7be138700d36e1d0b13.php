    ...
    <?php elseif(request('jenis_kegiatan_filter')): ?>
        ...
        <div class="text-center text-muted py-10">
            ...
            <button class="btn btn-light-primary mt-3"
                onclick="window.location.href='<?php echo e(route('admin.laporan-lpj.kegiatan_lainnya.index')); ?>'">
                Reset Filter
            </button>
        </div>
    <?php else: ?>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $kegiatanLainnya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr data-jenis-kegiatan="<?php echo e($kegiatan->nama_kegiatan ?? ''); ?>"
                        ...
                        <td class="text-start">
                            <?php echo e(\Carbon\Carbon::parse($kegiatan->created_at)->format('d M Y')); ?>
                                ...
                                <ul class="dropdown-menu dropdown-menu-custom">
                                   <li>
                                    ...
                                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                                        <li><a href="<?php echo e(route('admin.laporan-lpj.kegiatan_lainnya.edit', $kegiatan->id)); ?>"
                                    ...
                                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                                        <li><button type="button"
                                                ...
                                                data-route="<?php echo e(route('admin.laporan-lpj.kegiatan_lainnya.destroy', $kegiatan->id)); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/kegiatan_lainnya/_table.blade.php ENDPATH**/ ?>