<?php if($sportscienceData->isEmpty()): ?>
...
<?php else: ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle" id="kt_datatable_dom_positioning_sumberdaya">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $sportscienceData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="text-center">
                            <?php echo e(($sportscienceData->currentPage() - 1) * $sportscienceData->perPage() + $index + 1); ?>
                            ...
                            <div class="dropdown dropdown-action" data-row-id="<?php echo e($data->id); ?>">
                                ...
                                <ul class="dropdown-menu dropdown-menu-custom">
                                    ...
                                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                                        <li>
                                            <a href="<?php echo e(route('admin.laporan-lpj.bidang.sport-science.edit', $data->id)); ?>"
    ...
    <div class="table-footer">
        <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            ...
            <?php if(isset($sportscienceData) && method_exists($sportscienceData, 'hasPages') && $sportscienceData->hasPages()): ?>
                <div class="d-flex align-items-center gap-3">
                    <div class="text-muted small">
                        <?php echo e($sportscienceData->firstItem()); ?>-<?php echo e($sportscienceData->lastItem()); ?> of
                        <?php echo e($sportscienceData->total()); ?>

                    </div>

                    <div class="d-flex align-items-center gap-2">
                        <?php if($sportscienceData->onFirstPage()): ?>
                            <span class="pagination-arrow disabled">←</span>
                        <?php else: ?>
                            <a href="<?php echo e($sportscienceData->appends(request()->query())->previousPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Previous">←</a>
                        <?php endif; ?>

                        <?php
                            $current = $sportscienceData->currentPage();
                            $total = $sportscienceData->lastPage();
                        ...
                        <div class="d-flex align-items-center">
                            <?php for($i = $start; $i <= $end; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($sportscienceData->appends(request()->query())->url($i)); ?>"
                                       class="pagination-number pagination-link"><?php echo e($i); ?></a>
                                <?php endif; ?>
                            <?php endfor; ?>
                        </div>

                        <?php if($sportscienceData->hasMorePages()): ?>
                            <a href="<?php echo e($sportscienceData->appends(request()->query())->nextPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Next">→</a>
                        <?php else: ?>
                            <span class="pagination-arrow disabled">→</span>
            ...
            <?php elseif(isset($sportscienceData) && method_exists($sportscienceData, 'hasPages')): ?>
                <div class="text-muted small">
                    1-<?php echo e($sportscienceData->count()); ?> of <?php echo e($sportscienceData->total()); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/sportscience/_table.blade.php ENDPATH**/ ?>