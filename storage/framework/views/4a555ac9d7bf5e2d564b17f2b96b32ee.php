<?php if($perencanaanprogramData->isEmpty()): ?>
...
<?php else: ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle" id="kt_datatable_dom_positioning_sumberdaya">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $perencanaanprogramData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="text-center">
                            <?php echo e(($perencanaanprogramData->currentPage() - 1) * $perencanaanprogramData->perPage() + $index + 1); ?>
                            ...
                            <div class="dropdown dropdown-action" data-row-id="<?php echo e($data->id); ?>">
                                ...
                                <ul class="dropdown-menu dropdown-menu-custom">
                                    ...
                                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                                        <li>
                                            <a href="<?php echo e(route('admin.laporan-lpj.bidang.perencanaan-program.edit', $data->id)); ?>"
    ...
    <div class="table-footer">
        <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            ...
            <?php if(isset($perencanaanprogramData) && method_exists($perencanaanprogramData, 'hasPages') && $perencanaanprogramData->hasPages()): ?>
                <div class="d-flex align-items-center gap-3">
                    <div class="text-muted small">
                        <?php echo e($perencanaanprogramData->firstItem()); ?>-<?php echo e($perencanaanprogramData->lastItem()); ?> of
                        <?php echo e($perencanaanprogramData->total()); ?>

                    </div>

                    <div class="d-flex align-items-center gap-2">
                        <?php if($perencanaanprogramData->onFirstPage()): ?>
                            <span class="pagination-arrow disabled">←</span>
                        <?php else: ?>
                            <a href="<?php echo e($perencanaanprogramData->appends(request()->query())->previousPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Previous">←</a>
                        <?php endif; ?>

                        <?php
                            $current = $perencanaanprogramData->currentPage();
                            $total = $perencanaanprogramData->lastPage();
                        ...
                        <div class="d-flex align-items-center">
                            <?php for($i = $start; $i <= $end; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($perencanaanprogramData->appends(request()->query())->url($i)); ?>"
                                       class="pagination-number pagination-link"><?php echo e($i); ?></a>
                                <?php endif; ?>
                            <?php endfor; ?>
                        </div>

                        <?php if($perencanaanprogramData->hasMorePages()): ?>
                            <a href="<?php echo e($perencanaanprogramData->appends(request()->query())->nextPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Next">→</a>
                        <?php else: ?>
                            <span class="pagination-arrow disabled">→</span>
            ...
            <?php elseif(isset($perencanaanprogramData) && method_exists($perencanaanprogramData, 'hasPages')): ?>
                <div class="text-muted small">
                    1-<?php echo e($perencanaanprogramData->count()); ?> of <?php echo e($perencanaanprogramData->total()); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/perencanaan-program/_table.blade.php ENDPATH**/ ?>