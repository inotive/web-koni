...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        ...
        .dropdown-action {
            position: relative;
            z-index: 1055; /* Lebih tinggi dari modal */
        }
        .dropdown-menu-custom {
            ...
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap py-5">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                    ...
                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                        <a href="<?php echo e(route('admin.laporan-lpj.kegiatan_lainnya.create')); ?>" class="btn custom-red-button"
                            style="background-color: #F8285A !important; color: white !important; border-color: #F8285A !important;">
                            <i class="ki-duotone ki-plus fs-2" style="color: white !important;"></i>Tambah Laporan
                        </a>

<form action="<?php echo e(route('admin.laporan-lpj.kegiatan_lainnya.export')); ?>" method="POST" class="d-inline">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="data" value="<?php echo e(json_encode([])); ?>">
    <input type="hidden" name="title" value="LPJ_Kegiatan_Lainnya_<?php echo e(date('Ymd')); ?>">
        ...
        <i class="fas fa-file-export me-1" style="color: white !important;"></i>Export
                        ...
                        <div class="dropdown-menu p-3 shadow" style="min-width: 320px;">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="filter-jenis-kegiatan" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $kegiatanLainnya->pluck('nama_kegiatan')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($jenis); ?>"
                                            <?php echo e(request('jenis_kegiatan_filter') == $jenis ? 'selected' : ''); ?>>
                                            <?php echo e($jenis); ?>
            ...
            <div class="card-body position-relative">
                ...
                <div id="table-container">
                    <?php echo $__env->make('admin.laporan-lpj.kegiatan_lainnya._table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            window.exportToPDF = function(data) {
                ...
                form.method = 'POST';
                form.action = '<?php echo e(route('admin.laporan-lpj.kegiatan_lainnya.export')); ?>';
                form.target = '_blank';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/kegiatan_lainnya/index.blade.php ENDPATH**/ ?>