<?php $__env->startSection('pageTitle', 'Cabang Olahraga'); ?>
<?php $__env->startSection('mainSection', 'Konfigurasi'); ?>
<?php $__env->startSection('currentSection', 'Cabang Olahraga'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-2" style="padding:10px 30px">
        ...
        <a href="<?php echo e(route('admin.konfigurasi.cabang-olahraga.create')); ?>" class="btn"
                    ...
                    <div class="card">
                        <div class="card-body py-1">
                            <div class="table-header" style="border-radius: 12px 12px 0px 0px">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="filter-status" name="status" class="form-select">
                                                        ...
                                                        <option value="Pembinaan"
                                                            <?php echo e(request('status') == 'Pembinaan' ? 'selected' : ''); ?>>
                                                            Pembinaan</option>
                                                    </select>
                                                </div>
                                ...
                                <?php if(!(isset($cabors) && $cabors->isEmpty())): ?>
                            ...
                            <div class="table-container">
                                ...
                                <?php else: ?>
                                    <div class="table-responsive" id="tableContainer">
                                        <?php echo $__env->make('admin.cabang-olahraga.partials.table', [
                                            'cabors' => $cabors,
                                        ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>

                                    <!-- Pagination Section -->
                                    <?php if(isset($cabors) && $cabors->total() > 0): ?>
                                        <div class="table-footer">
                                            <?php echo $__env->make('admin.cabang-olahraga.partials.pagination', [
                                                'cabors' => $cabors,
                                            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    <?php endif; ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).ready(function() {
            ...
            const baseUrl = "<?php echo e(route('admin.konfigurasi.cabang-olahraga.index')); ?>";
            ...
            function showExportPreview(params) {
                ...
                // Get preview data
                const previewUrl = "<?php echo e(route('admin.konfigurasi.cabang-olahraga.export-preview')); ?>?" + params
                    .toString();
            ...
            function performExport(params) {
                ...
                try {
                    // Build export URL
                    const exportUrl = "<?php echo e(route('admin.konfigurasi.cabang-olahraga.export')); ?>?" + params
                        .toString();
    ...
    <?php if(session('cabor_created')): ?>
        <script>
            $(document).ready(() => toastr.success("<?php echo e(session('cabor_created')); ?>"));
        </script>
    <?php endif; ?>

    <?php if(session('cabor_updated')): ?>
        <script>
            $(document).ready(() => toastr.success("<?php echo e(session('cabor_updated')); ?>"));
        </script>
    <?php endif; ?>

    <?php if(session('cabor_deleted')): ?>
        <script>
            $(document).ready(() => toastr.success("<?php echo e(session('cabor_deleted')); ?>"));
        </script>
    <?php endif; ?>

    <?php if(session('error')): ?>
        <script>
            $(document).ready(() => toastr.error("<?php echo e(session('error')); ?>"));
        </script>
    <?php endif; ?>

    <?php if(session('success')): ?>
        <script>
            $(document).ready(() => toastr.success("<?php echo e(session('success')); ?>"));
        </script>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gustibagus/Documents/GitHub/web-koni/resources/views/admin/cabang-olahraga/index.blade.php ENDPATH**/ ?>