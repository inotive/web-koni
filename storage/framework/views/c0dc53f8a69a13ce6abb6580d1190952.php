<?php $__env->startSection('pageTitle', 'Edit FPTI'); ?>
...
<?php $__env->startSection('subSection4', 'FPTI'); ?>
<?php $__env->startSection('subSection4Url', route('admin.laporan-lpj.bidang.prestasi.cabor-terukur.FPTI.index')); ?>
<?php $__env->startSection('currentSection', 'Edit FPTI'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4" style="padding: 20px 20px">
        <h3 class="fw-bold fs-2 mb-0 text-dark">Edit Data FPTI</h3>
    </div>
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-terukur.FPTI.update', $fpti->id)); ?>" method="POST"
                            ...
                            <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($key === 'keterangan_tambahan'): ?>
                                    ...
                                    <?php echo $__env->make('admin.laporan-lpj.bidang.prestasi.terukur.fpti.components.file-upload', [
                                        'name' => 'foto_jurnal',
                                        'label' => 'Foto Jurnal',
                                        'type' => 'image',
                                        'maxFiles' => 10,
                                        'maxSize' => 10,
                                        'existingFiles' => $fpti->foto_jurnal ?? [],
                                        'accept' => 'image/*',
                                    ...
                                    <?php echo $__env->make('admin.laporan-lpj.bidang.prestasi.terukur.fpti.components.file-upload', [
                                        ...
                                        'maxFiles' => 10,
                                        'maxSize' => 10,
                                        'existingFiles' => $fpti->dokumen_lpj ?? [],
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                rows="3"
                                                <?php echo e($field['required'] ? 'required' : ''); ?>><?php echo e(old($key, $fpti->$key)); ?></textarea>
                                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="<?php echo e($field['placeholder'] ?? ''); ?>"
                                                value="<?php echo e(old($key, $fpti->$key)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-9 offset-md-3 d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-terukur.FPTI.index')); ?>"
    ...
    <?php echo $__env->make('admin.laporan-lpj.bidang.prestasi.terukur.fpti.components.file-upload-scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            initFileUpload({
                ...
                existingFiles: <?php echo json_encode($fpti->foto_jurnal ?? [], 15, 512) ?>
            });
            ...
            initFileUpload({
                ...
                maxFiles: 10,
                maxSize: 10 * 1024 * 1024,
                existingFiles: <?php echo json_encode($fpti->dokumen_lpj ?? [], 15, 512) ?>
            });
        });
    </script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/prestasi/terukur/fpti/edit.blade.php ENDPATH**/ ?>