...
<head>
    ...
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'Dashboard'); ?> - KONI Tabalong">
    <meta property="og:description" content="Sistem Informasi Manajemen KONI Kabupaten Tabalong">
    <meta property="og:image" content="<?php echo e(asset('assets/img/logo-koni-simplified.png')); ?>">
    <meta property="og:site_name" content="KONI Tabalong">
    
    <!-- Twitter Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('title', 'Dashboard'); ?> - KONI Tabalong">
    <meta name="twitter:description" content="Sistem Informasi Manajemen KONI Kabupaten Tabalong">
    <meta name="twitter:image" content="<?php echo e(asset('assets/img/logo-koni-simplified.png')); ?>">
