    ...
    <div class="d-grid gap-5 border-0">
        <div class="d-flex justify-content-between align-items-center container">
            <div class="d-none d-md-block">
                <h1>Cabor Akurasi</h1>
                <span>Informasi Cabor Akurasi untuk tahun <?php echo e($selectedYear); ?></span>
            </div>
            <form id="filter" action="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi')); ?>" method="GET" class="d-flex gap-3">
                ...
                <select name="year" class="form-select border border-gray-500 py-2" style="width: 120px" onchange="this.form.submit()">
