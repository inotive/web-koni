...
<?php else: ?>
    <div class="table-responsive">
        <table class="table table-hover align-middle" id="atlet-table">
            ...
            <tbody>
                <?php if(isset($atlet)): ?>
                    <?php $__empty_1 = true; $__currentLoopData = $atlet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr>
                            <td><?php echo e($atlet->firstItem() + $loop->index); ?></td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-1">
                                    <a href="<?php echo e(route('admin.konfigurasi.atlet.show', ['atlet' => $item->id, 'from' => 'atlet'])); ?>"
                                    class="btn btn-icon btn-sm btn-light-primary"
                                    title="Detail">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.konfigurasi.atlet.edit', $item->id)); ?>"
                                    ...
                                    <button type="button"
                                            ...
                                            data-route="<?php echo e(route('admin.konfigurasi.atlet.destroy', $item->id)); ?>"
    ...
    <div class="table-footer">
        <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
            ...
            <?php if(isset($atlet) && method_exists($atlet, 'hasPages') && $atlet->hasPages()): ?>
                <div class="d-flex align-items-center gap-3">
                    <div class="text-muted small">
                        <?php echo e($atlet->firstItem()); ?>-<?php echo e($atlet->lastItem()); ?> of
                        <?php echo e($atlet->total()); ?>

                    </div>

                    <div class="d-flex align-items-center gap-2">
                        <?php if($atlet->onFirstPage()): ?>
                            <span class="pagination-arrow disabled">←</span>
                        <?php else: ?>
                            <a href="<?php echo e($atlet->appends(request()->query())->previousPageUrl()); ?>"
                        ...
                        <div class="d-flex align-items-center">
                            <?php for($i = $start; $i <= $end; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($atlet->appends(request()->query())->url($i)); ?>"
                                       class="pagination-number pagination-link"><?php echo e($i); ?></a>
                                <?php endif; ?>
                            <?php endfor; ?>
                        </div>

                        <?php if($atlet->hasMorePages()): ?>
                            <a href="<?php echo e($atlet->appends(request()->query())->nextPageUrl()); ?>"
                               class="pagination-arrow pagination-link"
                               aria-label="Next">→</a>
                        <?php else: ?>
                            <span class="pagination-arrow disabled">→</span>
            ...
            <?php elseif(isset($atlet) && method_exists($atlet, 'hasPages')): ?>
                <div class="text-muted small">
                    1-<?php echo e($atlet->count()); ?> of <?php echo e($atlet->total()); ?>
...
<?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/atlet/_table.blade.php ENDPATH**/ ?>