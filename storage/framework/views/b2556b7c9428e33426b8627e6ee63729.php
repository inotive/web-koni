<?php $__env->startSection('pageTitle', 'Tambah Kegiatan Lainnya'); ?>
<?php $__env->startSection('mainSection', 'Laporan Pertanggungjawaban'); ?>
<?php $__env->startSection('subSection', 'Kegiatan Lainnya'); ?>
<?php $__env->startSection('subSectionUrl', route('admin.laporan-lpj.kegiatan_lainnya.index')); ?>
<?php $__env->startSection('currentSection', 'Tambah Kegiatan Lainnya'); ?>
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo e(route('admin.laporan-lpj.kegiatan_lainnya.store')); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row align-items-center mb-3">
            <div class="col-md-3">
                <label for="<?php echo e($key); ?>" class="form-label <?php if($field['required']): ?> required <?php endif; ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="row mt-4">
        <div class="col-md-9 offset-md-3 d-flex justify-content-between">
            ...
            <a href="<?php echo e(route('admin.laporan-lpj.kegiatan_lainnya.index')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/kegiatan_lainnya/create.blade.php ENDPATH**/ ?>