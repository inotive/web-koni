    ...
    <div class="col-12">
        <div class="top-progress-wrapper">
            ...
            <div class="d-flex justify-content-between mb-2">
                <h1 id="anggaranDisplay" class="fw-bold mb-1">Rp. <?php echo e(number_format($totalAnggaran ?? 0, 0, ',', '.')); ?> / Rp. <?php echo e(number_format($targetAnggaran, 0, ',', '.')); ?></h1>
                <h3 id="anggaranPercentage" class="text-muted mb-0" data-bs-toggle="tooltip" title="<?php echo e(round($anggaranPercentage, 2)); ?>% dari total anggaran">
            ...
            <div class="progress" style="height: 18px; border-radius: 12px; background-color: #f1f1f1;">
                <div class="progress-bar progress-bar-striped progress-bar-animated"
                    ...
                    aria-valuenow="<?php echo e($anggaranPercentage); ?>"
                    aria-valuemin="0"
                    aria-valuemax="100">
                </div>
            </div>
                    ...
                    <form id="editAnggaranForm">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="target_anggaran" name="target_anggaran" 
                                   value="<?php echo e(number_format($targetAnggaran ?? 200000000000, 0, '', '')); ?>" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="target_kegiatan" name="target_kegiatan" 
                                   value="<?php echo e($targetKegiatan ?? 10); ?>" required>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
