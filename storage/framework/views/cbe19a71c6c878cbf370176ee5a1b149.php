            ...
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap py-5">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                    ...
                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                        <a href="<?php echo e(route('admin.laporan-lpj.kegiatan-lainnya.create')); ?>" class="btn custom-red-button"
                            style="background-color: #F8285A !important; color: white !important; border-color: #F8285A !important;">
                            <i class="ki-duotone ki-plus fs-2" style="color: white !important;"></i>Tambah Laporan
                        </a>

                        <form action="<?php echo e(route('admin.laporan-lpj.kegiatan-lainnya.export')); ?>" method="POST"
                            class="d-inline">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="data" value="<?php echo e(json_encode([])); ?>">
                            <input type="hidden" name="title" value="LPJ_Kegiatan-Lainnya_<?php echo e(date('Ymd')); ?>">
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.exportToPDF = function(data) {
                ...
                form.method = 'POST';
                form.action = '<?php echo e(route('admin.laporan-lpj.kegiatan-lainnya.export')); ?>';
                form.target = '_blank';
