<?php $__env->startSection('pageTitle', 'ptmsi'); ?>
...
<?php $__env->startSection('currentSection', 'ptmsi'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex flex-column mb-8">
        <h1 class="text-dark fw-bold mb-1">Laporan ptmsi</h1>
    </div>
    ...
    <div class="row col-12 mt-5">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap py-5">
                <h3 class="card-title fw-bold fs-4 mb-0">Daftar ptmsi - 2025</h3>

                
                <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                    
                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                        <a href="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-permainan.ptmsi.create')); ?>" class="btn custom-red-button"
                        ...
                        <div class="dropdown-menu p-3 shadow" style="min-width: 320px;">
                            <div class="mb-3">
                                ...
                                <select id="filter-jenis-kegiatan" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $ptmsiData->pluck('nama_kegiatan')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card-body position-relative">
                ...
                <div id="table-container">
                    <?php echo $__env->make('admin.laporan-lpj.bidang.prestasi.permainan.ptmsi._table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function showDetailModal(ptmsi) {
            ...
            if (ptmsi.foto_jurnal && ptmsi.foto_jurnal.length > 0) {
                fotoHtml = `
                    <div class="row g-3">
                        ${ptmsi.foto_jurnal.map(f => `
            ...
            if (ptmsi.dokumen_lpj && ptmsi.dokumen_lpj.length > 0) {
                dokumenHtml = `
                    <div class="d-flex flex-column gap-2">
                        ${ptmsi.dokumen_lpj.map(d => {
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="mb-2">
                                    ...
                                    <p class="mb-0 text-dark">${ptmsi.nama_program}</p>
                                    <small class="text-muted">${ptmsi.nama_kegiatan}</small>
                                </div>
                                ${ptmsi.tempat_kegiatan ? `
                                    <div class="mb-2">
                                        <label class="fw-semibold text-dark mb-1">Tempat Kegiatan:</label>
                                        <p class="mb-0 text-dark">${ptmsi.tempat_kegiatan}</p>
                                    </div>
                                ` : ''}
                                ${ptmsi.tanggal_kegiatan ? `
                                    <div>
                                        <label class="fw-semibold text-dark mb-1">Tanggal Kegiatan:</label>
                                        <p class="mb-0 text-dark">${new Date(ptmsi.tanggal_kegiatan).toLocaleDateString('id-ID')}</p>
                                    </div>
                                ` : ''}
                            </div>
                        </div>

                        ${ptmsi.jumlah_anggaran ? `
                            <div class="mb-4">
                                ...
                                <div class="bg-light p-3 rounded">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0 text-success fs-5 fw-bold">${formatRupiah(ptmsi.jumlah_anggaran)}</p>
                                        </div>
                                        ${ptmsi.jumlah_realisasi ? `
                                            <div class="col-md-6">
                                                <label class="fw-semibold text-dark mb-1">Realisasi:</label>
                                                <p class="mb-0 text-info fs-5 fw-bold">${formatRupiah(ptmsi.jumlah_realisasi)}</p>
                                            </div>
                                        ` : ''}
                                    </div>
                                </div>
                        ...
                        ${ptmsi.sumber_dana ? `
                            <div class="mb-4">
                                ...
                                <div class="bg-light p-3 rounded">
                                    <p class="mb-0 text-dark">${ptmsi.sumber_dana}</p>
                                </div>
                            </div>
                        ` : ''}
                        ...
                        ${ptmsi.keterangan ? `
                            <div class="mb-2">
                                ...
                                <div class="bg-light p-3 rounded">
                                    <p class="mb-0 text-dark">${ptmsi.keterangan}</p>
                                </div>
                            </div>
                        ` : ''}
...
$(document).ready(function() {
        ...
        $('#submitBtnDelete').on('click', function() {
            ...
            const url = "<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-permainan.ptmsi.destroy', ':id')); ?>".replace(':id', deleteId);
        ...
        function deleteItemWithSwal(itemId, itemName = 'item ini') {
            const url = "<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-permainan.ptmsi.destroy', ':id')); ?>".replace(':id', itemId);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/prestasi/permainan/ptmsi/index.blade.php ENDPATH**/ ?>