<?php $__env->startSection('pageTitle', 'Tambah IMI'); ?>
...
<?php $__env->startSection('currentSection', 'Tambah IMI'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4" style="padding: 20px 20px">
        <h3 class="fw-bold fs-2 mb-0 text-dark">Tambah Data IMI</h3>
    </div>
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-terukur.IMI.store')); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/prestasi/terukur/IMI/create.blade.php ENDPATH**/ ?>