                            ...
                            <div class="table-header" style="border-radius: 12px 12px 0px 0px">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <a href="<?php echo e(route('admin.konfigurasi.atlet.export')); ?>" id="export-csv"
                                            class="btn btn-outline-secondary filter-btn-custom">
                                            <i class="fas fa-file-csv me-1"></i> Export
                                        </a>
                                        <div class="dropdown">
                                            <button class="btn btn-outline-secondary dropdown-toggle" type="button"
                                                style="border: #c7cdd3 1px solid; border-radius: 8px;"
                                                    ...
                                                    <select id="filter-cabor" class="form-select">
                                                        ...
                                                        <?php if(isset($allCabor)): ?>
                                                            <?php $__currentLoopData = $allCabor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nama): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($nama); ?>"><?php echo e($nama); ?>
                                ...
                                <?php if(!(isset($atlet) && $atlet->isEmpty())): ?>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div id="filter-info" class="text-muted">
                                            Menampilkan <span
                                                id="showing-count"><?php echo e(isset($atlet) ? $atlet->count() : 0); ?></span>
                                            dari <span id="total-count"><?php echo e(isset($atlet) ? $atlet->total() : 0); ?></span>
                                            atlet
                                        </div>
                                    </div>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thur/Documents/Inotive/web-koni/resources/views/admin/atlet/index.blade.php ENDPATH**/ ?>