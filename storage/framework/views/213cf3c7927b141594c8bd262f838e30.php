...
<body>
    ...
    <div class="letterhead">
        <img src="<?php echo e(public_path('assets/img/kop-nobg.png')); ?>"
             alt="KONI Letterhead"
    ...
    <div class="content">
        <div class="lpj-item no-break">
            ...
            <table class="info-table">
                ...
                <?php if($lpj->tanggal_kegiatan): ?>
                <tr>
                    <th>Tanggal Kegiatan</th>
                    <td><?php echo e(\Carbon\Carbon::parse($lpj->tanggal_kegiatan)->format('d F Y')); ?></td>
                </tr>
                <?php endif; ?>
...
<?php /**PATH C:\Users\Javier\Documents\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang_new/dynamic/pdf-export.blade.php ENDPATH**/ ?>