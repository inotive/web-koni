...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-2" style="padding:10px 30px">
        <h2 class="fw-bold fs-2 mb-0 text-dark">Prestasi</h2>
        <a href="<?php echo e(route('admin.konfigurasi.prestasi.create')); ?>" class="btn"
            ...
            <i class="ki-duotone ki-plus fs-4 me-2" style="color: white !important;"></i>Tambah Prestasi
        </a>
    </div>
                            ...
                            <div class="table-header">
                                <div class="header-wrapper">
                                    ...
                                    <div class="header-controls">
                                        ...
                                        <a href="<?php echo e(route('admin.konfigurasi.prestasi.export')); ?>" id="export-csv"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu p-3 shadow"
                                                style="min-width: 280px; border: 1px solid #ced4da;">
                                                <div class="mb-3">
                                                ...
                                                <div class="d-flex gap-2">
                                                    <button type="button" id="apply-filters"
                                                        ...
                                                        style="border: 1px solid #0d6efd !important;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gustibagus/Documents/GitHub/web-koni/resources/views/admin/prestasi/index.blade.php ENDPATH**/ ?>