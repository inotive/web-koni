<?php $__env->startSection('pageTitle', 'PERBAKIN - Menembak'); ?>
...
<?php $__env->startSection('subSection3', 'Cabor akurasi'); ?>
<?php $__env->startSection('subSection3Url', route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi')); ?>
<?php $__env->startSection('currentSection', 'PERBAKIN - Menembak'); ?>
...
<?php $__env->startSection('content'); ?>
    <style>
        ...
        /* Custom tooltip styling to match the dperbaikingn */
        .custom-tooltip {
    ...
    <div class="d-flex flex-column mb-8">
        <h1 class="text-dark fw-bold mb-1">Laporan PERBAKIN - Menembak</h1>
    </div>
    ...
    <div class="row col-12 mt-5">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap py-5">
                <h3 class="card-title fw-bold fs-4 mb-0">Daftar PERBAKIN - Menembak 2025</h3>

                
                <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                    
                    <?php if(auth()->user()->hasRole('superadmin')): ?>
                        <a href="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi.perbaikin.create')); ?>" class="btn custom-red-button"
                        ...
                        <div class="dropdown-menu p-3 shadow" style="min-width: 320px;">
                            <div class="mb-3">
                                ...
                                <select id="filter-jenis-kegiatan" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $perbaikinData->pluck('nama_kegiatan')->unique()->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($kegiatan); ?>"
                                            <?php echo e(request('jenis_kegiatan_filter') == $kegiatan ? 'selected' : ''); ?>>
                                            <?php echo e($kegiatan); ?>
            ...
            <div class="card-body position-relative">
                ...
                <div id="table-container">
                    <?php echo $__env->make('admin.laporan-lpj.bidang.prestasi.akurasi.perbaikin._table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function initializeDropdownEvents() {
                ...
                $(window).on('rperbaikinze', function() {
        ...
        function showDetailModal(perbaikin) {
            ...
            if (perbaikin.foto_jurnal && perbaikin.foto_jurnal.length > 0) {
                fotoHtml = `
                    <div class="row g-3">
                        ${perbaikin.foto_jurnal.map(f => `
            ...
            if (perbaikin.dokumen_lpj && perbaikin.dokumen_lpj.length > 0) {
                dokumenHtml = `
                    <div class="d-flex flex-column gap-2">
                        ${perbaikin.dokumen_lpj.map(d => {
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="bg-light p-3 rounded">
                                <div class="mb-2">
                                    ...
                                    <p class="mb-0 text-dark">${perbaikin.nama_program}</p>
                                    <small class="text-muted">${perbaikin.nama_kegiatan}</small>
                                </div>
                                ${perbaikin.tempat_kegiatan ? `
                                    <div class="mb-2">
                                        <label class="fw-semibold text-dark mb-1">Tempat Kegiatan:</label>
                                        <p class="mb-0 text-dark">${perbaikin.tempat_kegiatan}</p>
                                    </div>
                                ` : ''}
                                ${perbaikin.tanggal_kegiatan ? `
                                    <div>
                                        <label class="fw-semibold text-dark mb-1">Tanggal Kegiatan:</label>
                                        <p class="mb-0 text-dark">${new Date(perbaikin.tanggal_kegiatan).toLocaleDateString('id-ID')}</p>
                                    </div>
                                ` : ''}
                            </div>
                        </div>

                        ${perbaikin.jumlah_anggaran ? `
                            <div class="mb-4">
                                ...
                                <div class="bg-light p-3 rounded">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0 text-success fs-5 fw-bold">${formatRupiah(perbaikin.jumlah_anggaran)}</p>
                                        </div>
                                        ${perbaikin.jumlah_realisasi ? `
                                            <div class="col-md-6">
                                                <label class="fw-semibold text-dark mb-1">Realisasi:</label>
                                                <p class="mb-0 text-info fs-5 fw-bold">${formatRupiah(perbaikin.jumlah_realisasi)}</p>
                                            </div>
                                        ` : ''}
                                    </div>
                                </div>
                        ...
                        ${perbaikin.sumber_dana ? `
                            <div class="mb-4">
                                ...
                                <div class="bg-light p-3 rounded">
                                    <p class="mb-0 text-dark">${perbaikin.sumber_dana}</p>
                                </div>
                            </div>
                        ` : ''}
                        ...
                        ${perbaikin.keterangan ? `
                            <div class="mb-2">
                                ...
                                <div class="bg-light p-3 rounded">
                                    <p class="mb-0 text-dark">${perbaikin.keterangan}</p>
                                </div>
                            </div>
                        ` : ''}
...
$(document).ready(function() {
        ...
        $('#submitBtnDelete').on('click', function() {
            ...
            const url = "<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi.perbaikin.destroy', ':id')); ?>".replace(':id', deleteId);
        ...
        function deleteItemWithSwal(itemId, itemName = 'item ini') {
            const url = "<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi.perbaikin.destroy', ':id')); ?>".replace(':id', itemId);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/prestasi/Akurasi/perbaikin/index.blade.php ENDPATH**/ ?>