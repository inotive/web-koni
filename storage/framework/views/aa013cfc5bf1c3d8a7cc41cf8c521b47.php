<?php $__env->startSection('pageTitle', 'Cabor Terukur'); ?>
...
<?php $__env->startSection('subSection2Url', route('admin.laporan-lpj.bidang.prestasi.index', ['year' => $selectedYear])); ?>
<?php $__env->startSection('currentSection', 'Cabor Terukur'); ?>
    ...
    <div class="d-grid gap-5 border-0">
        <div class="d-flex justify-content-between align-items-center container">
            <div class="d-none d-md-block">
                <h1>Cabor Terukur</h1>
                <span>Informasi Cabor Terukur untuk tahun <?php echo e($selectedYear); ?></span>
            </div>
            <form id="filter" action="<?php echo e(route('admin.laporan-lpj.bidang.prestasi.cabor-terukur')); ?>" method="GET" class="d-flex gap-3">
        ...
        <div id="table" class="container">
            <?php echo $__env->make('admin.laporan-lpj.bidang.prestasi.Terukur._table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/prestasi/Terukur/index.blade.php ENDPATH**/ ?>