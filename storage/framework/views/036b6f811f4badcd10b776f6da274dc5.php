<?php $__env->startSection('pageTitle', 'Edit Mobilisasi Sumber Daya'); ?>
<?php $__env->startSection('mainSection', 'Laporan LPJ'); ?>
<?php $__env->startSection('subSection', 'Mobilisasi Sumber Daya'); ?>
<?php $__env->startSection('subSectionUrl', route('admin.laporan-lpj.bidang.mobilisasi-sumberdaya.index')); ?>
<?php $__env->startSection('currentSection', 'Edit Mobilisasi Sumber Daya'); ?>
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo e(route('admin.laporan-lpj.bidang.mobilisasi-sumberdaya.update', $sumberdaya->id)); ?>" method="POST"
                            ...
                            <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row align-items-start mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <?php if($sumberdaya->foto_jurnal && count($sumberdaya->foto_jurnal) > 0): ?>
                                            <div class="current-files">
                                                <h6>Foto saat ini:</h6>
                                                <div id="existingFotoContainer">
                                                    <?php $__currentLoopData = $sumberdaya->foto_jurnal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <input type="hidden" name="existing_foto_jurnal" id="existingFotoInput" value="<?php echo e(json_encode($sumberdaya->foto_jurnal)); ?>">
                                            </div>
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row align-items-start mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <?php if($sumberdaya->dokumen_lpj && count($sumberdaya->dokumen_lpj) > 0): ?>
                                            <div class="current-files">
                                                <h6>Dokumen saat ini:</h6>
                                                <div id="existingDokumenContainer">
                                                    <?php $__currentLoopData = $sumberdaya->dokumen_lpj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dokumen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                ...
                                                <input type="hidden" name="existing_dokumen_lpj" id="existingDokumenInput" value="<?php echo e(json_encode($sumberdaya->dokumen_lpj)); ?>">
                                            </div>
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                rows="3"
                                                <?php echo e($field['required'] ? 'required' : ''); ?>><?php echo e(old($key, $sumberdaya->$key)); ?></textarea>
                                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>"
                                                placeholder="<?php echo e($field['placeholder'] ?? ''); ?>"
                                                value="<?php echo e(old($key, $sumberdaya->$key)); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-9 offset-md-3 d-flex justify-content-between">
                                    ...
                                    <a href="<?php echo e(route('admin.laporan-lpj.bidang.mobilisasi-sumberdaya.index')); ?>"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let existingFotoFiles = <?php echo json_encode($sumberdaya->foto_jurnal ?? [], 15, 512) ?>;
            let existingDokumenFiles = <?php echo json_encode($sumberdaya->dokumen_lpj ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/laporan-lpj/bidang/mobilisasi-sumberdaya/edit.blade.php ENDPATH**/ ?>