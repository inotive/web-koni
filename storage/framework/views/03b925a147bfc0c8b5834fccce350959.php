                        ...
                        <tr data-tahun="<?php echo e($prestasi->tahun); ?>" data-nama="<?php echo e($prestasi->subject?->nama ?? '-'); ?>">
                            ...
                            <td>
                                <div class="d-flex flex-column">
                                    ...
                                    <small class="text-muted" title="<?php echo e(class_basename($prestasi->subject_type)); ?>">
                                        <?php echo e(class_basename($prestasi->subject_type)); ?>
                                ...
                                <div class="d-flex justify-content-center gap-1">
                                    <?php if($detailRoute): ?>
                                        <a href="<?php echo e($detailRoute); ?>" class="btn btn-icon btn-sm btn-light-primary"
                                            title="Lihat Detail <?php echo e(class_basename($prestasi->subject_type)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\Users\ThinkPad\OneDrive\Dokumen\GitHub\web-koni\resources\views/admin/prestasi/_table.blade.php ENDPATH**/ ?>