            ...
            <tbody>
                @if(isset($pelatih))
                    @forelse ($pelatih as $index => $item)
                        ...
                        @endphp
                        <tr>
                            <td>{{ $pelatih->firstItem() + $loop->index }}</td>
            ...
            @if (isset($pelatih) && method_exists($pelatih, 'hasPages') && $pelatih->hasPages())
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @else
                            <a href="{{ $pelatih->appends(request()->query())->previousPageUrl() }}"
                        ...
                        <div class="d-flex align-items-center">
                            @for ($i = $start; $i <= $end; $i++)
                                ...
                                @else
                                    <a href="{{ $pelatih->appends(request()->query())->url($i) }}"
                        ...
                        @if ($pelatih->hasMorePages())
                            <a href="{{ $pelatih->appends(request()->query())->nextPageUrl() }}"
                               class="pagination-arrow pagination-link"
                               aria-label="Next">→</a>
                        @else
                            <span class="pagination-arrow disabled">→</span>
