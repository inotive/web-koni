...
<div class="modal fade" tabindex="-1" id="kt_modal_{{ $value->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('admin.hak-akses.permission.update', $value->id) }}">
                @method('PUT')
                @csrf
                    ...
                    <div class="input-group mb-5">
                        ...
                        <div class="col-xl-12">
                            <input type="text" class="form-control" id="inputgroup" name="group"
                                   value="{{ old('group', $value->group) }}" required placeholder="Masukkan Nama Group"
                    ...
                    <div class="input-group mb-5">
                        ...
                        <div class="col-xl-12">
                            <input type="text" class="form-control" id="inputDisplayName" name="display_name"
                                   value="{{ old('display_name', $value->display_name) }}" required
