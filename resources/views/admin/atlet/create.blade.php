...
<div class="container mt-4">
    <div class="card card-form">
        <div class="card-body p-4 p-md-5">
            <h3 class="fw-bold mb-4">Tambah Data Atlet</h3>
            ...
            <form action="{{ route('admin.konfigurasi.atlet.store') }}" method="POST" enctype="multipart/form-data">
                ...
                @php
                $fields = [
                    'nama' => ['label' => 'Nama Lengkap', 'type' => 'text', 'placeholder' => 'Masukkan nama lengkap', 'required' => true],
                    'cabor' => ['label' => 'Cabang Olahraga', 'type' => 'select', 'options' => ['Sepak Bola', 'Basket', 'Badminton', 'Renang', 'Atletik', 'Tenis', 'Voli'], 'required' => true],
                    'email' => ['label' => 'Email', 'type' => 'email', 'placeholder' => 'emailatlet@gmail.com', 'required' => false],
                    'no_telepon' => ['label' => 'No Telepon', 'type' => 'text', 'placeholder' => '0895 9271 8263', 'required' => false],
                    'tanggal_lahir' => ['label' => 'Tanggal Lahir', 'type' => 'date', 'required' => true],
                    'tempat_lahir' => ['label' => 'Tempat Lahir', 'type' => 'text', 'placeholder' => 'Balikpapan, Kalimantan Timur', 'required' => true],
                    'jenis_kelamin' => ['label' => 'Jenis Kelamin', 'type' => 'select', 'options' => ['Laki-laki', 'Perempuan'], 'required' => true],
                    'alamat' => ['label' => 'Alamat (Sesuai KTP)', 'type' => 'textarea', 'placeholder' => 'Jln Prapatan Dalam RT 43 NO.08, Kelurahan Prapatan', 'required' => true],
                ];
                @endphp
