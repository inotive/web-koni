...
<style>
    ...
    .table th:nth-child(3), .table td:nth-child(3) { width: 140px; text-align: center; } /* Nama & Cabor */
    .table th:nth-child(4), .table td:nth-child(4) { width: 110px; text-align: center; } /* Tempat & Tanggal Lahir */
    .table th:nth-child(5), .table td:nth-child(5) { width: 100px; text-align: center; } /* Alamat */
    .table th:nth-child(6), .table td:nth-child(6) { width: 70px; text-align: center; } /* Jenis Kelamin */
    .table th:nth-child(7), .table td:nth-child(7) { width: 80px; text-align: center; } /* Usia */
    .table th:nth-child(8), .table td:nth-child(8) { width: 80px; text-align: center; } /* Telepon */
    .table th:nth-child(9), .table td:nth-child(9) { width: 110px; text-align: center; } /* Email */
    .table th:nth-child(10), .table td:nth-child(10) { width: 120px; text-align: center; } /* Prestasi */
    .table th:nth-child(11), .table td:nth-child(11) { width: 90px; text-align: center; } /* Tanggal Update */
...
<div class="notification-toast">
    @if (session('success'))
        <div class="toast show align-items-center text-white border-0 @if(session('action') === 'store') toast-success @elseif(session('action') === 'update') toast-warning @elseif(session('action') === 'destroy') toast-error @endif" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex">
                <div class="toast-body">
                    <i class="fas @if(session('action') === 'store') fa-check-circle @elseif(session('action') === 'update') fa-exclamation-circle @elseif(session('action') === 'destroy') fa-trash-alt @endif me-2"></i>
                    {{ session('success') }}
                </div>
                        ...
                        @if (!(isset($atlets) && $atlets->isEmpty()))
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div id="filter-info" class="text-muted">
                                    Menampilkan <span id="showing-count">{{ isset($atlets) ? $atlets->count() : 0 }}</span> dari <span
                                        id="total-count">{{ isset($atlets) ? $atlets->total() : 0 }}</span> atlet
                                </div>
                            </div>
                        @endif
                    </div>
                            ...
                            <table class="table table-hover align-middle" id="kt_datatable_dom_positioning">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Foto</th>
                                        <th><a href="{{ sortUrl('nama') }}" class="text-dark text-decoration-none">Nama Atlet & Cabor
                                                {!! sortIcon('nama') !!}</a></th>
                                        ...
                                        <th><a href="{{ sortUrl('jenis_kelamin') }}"
                                                class="text-dark text-decoration-none">Kelamin {!! sortIcon('jenis_kelamin') !!}</a></th>
                                        <th><a href="{{ sortUrl('tanggal_lahir') }}"
                                ...
                                <tbody>
                                    @if(isset($atlets))
                                        @forelse ($atlets as $index => $item)
                                            ...
                                            @endphp
                                            <tr data-cabor="{{ $caborNama }}" data-gender="{{ $item->jenis_kelamin }}"
                                                data-age="{{ $age }}"
                                                ...
                                                <td>
                                                    @if ($item->foto_atlet)
                                                        <img src="{{ Storage::url($item->foto_atlet) }}" width="40" height="40" class="rounded-circle object-fit-cover">
                                                    @else
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-1">
                                                        ...
                                                        <form action="{{ route('admin.konfigurasi.atlet.destroy', $item->id) }}"
                                                                method="POST"
                                                                class="d-inline"
