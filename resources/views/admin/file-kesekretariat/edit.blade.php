        ...
        <div class="row">
            <div class="card card-form">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form id="editFileForm" action="{{ route('admin.file-kesekretariat.update', $fileKesekretariat) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 text-muted small">{{ $fileKesekretariat->dokumen_file }}</p>
                                            </div>
                                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-9 offset-md-3 d-flex justify-content-between">
                                ...
                                <a href="{{ route('admin.file-kesekretariat.index') }}" class="btn btn-secondary px-4">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    $(document).ready(function() {
        ...
        uploadInput.on('change', function() {
            ...
            if (file) {
                ...
                fileNameDisplay.textContent = '{{ $fileKesekretariat->dokumen_file ? "Klik untuk mengubah dokumen" : "Seret dan lepas file di sini, atau klik untuk mengunggah." }}';
        ...
        $('#editFileForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    setTimeout(function() {
                        window.location.href = "{{ route('admin.file-kesekretariat.index') }}";
                    }, 1500);
                },
                error: function(xhr) {
                    hideLoading();
