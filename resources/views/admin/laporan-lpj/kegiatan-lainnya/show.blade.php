...
@section('currentSection', 'Detail Kegiatan Lainnya')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('admin.laporan-lpj.kegiatan-lainnya.export', $kegiatanLainnya->id) }}" 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <p class="mb-0 text-dark fs-5">{{ $kegiatanLainnya->nama_program }}</p>
                            </div>
                            
                            <div class="mb-5">
                                <label class="fw-semibold text-dark mb-2">Nama Kegiatan:</label>
                                <p class="mb-0 text-dark fs-5">{{ $kegiatanLainnya->nama_kegiatan }}</p>
                            </div>
                            
                            <div class="mb-5">
                                <label class="fw-semibold text-dark mb-2">Volume:</label>
                                <p class="mb-0 text-dark fs-5">{{ $kegiatanLainnya->volume ?? '-' }}</p>
                            </div>
                            
                            <div class="mb-5">
                                <label class="fw-semibold text-dark mb-2">Harga Satuan:</label>
                                <p class="mb-0 text-dark fs-5">
                                    Rp {{ number_format($kegiatanLainnya->jumlah_harga_satuan ?? 0, 0, ',', '.') }}
                                </p>
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <p class="mb-0 text-dark fs-5 text-success fw-bold">
                                    Rp {{ number_format($kegiatanLainnya->jumlah_harga ?? 0, 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="bg-light p-4 rounded">
                                    <p class="mb-0 text-dark" style="white-space: pre-wrap;">{{ $kegiatanLainnya->keterangan_tambahan }}</p>
                                </div>
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            @if($kegiatanLainnya->dokumen_lpj && count($kegiatanLainnya->dokumen_lpj) > 0)
                                @foreach($kegiatanLainnya->dokumen_lpj as $dokumen)
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center p-3 border rounded bg-light">
                                            <i class="{{ $iconClass }} me-3" style="font-size: 2em;"></i>
                                            <div class="flex-grow-1">
                                                <div class="fw-medium text-dark">{{ $originalName }}</div>
