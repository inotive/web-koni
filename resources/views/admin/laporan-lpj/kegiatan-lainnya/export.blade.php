...
<body>
    ...
    <div class="content">
        ...
        <table class="info-table">
            ...
            @if($kegiatanLainnya->created_at)
            <tr>
                <th>Tanggal Ditambahkan</th>
                <td>{{ \Carbon\Carbon::parse($kegiatanLainnya->created_at)->format('d F Y') }}</td>
            </tr>
            @endif
                                ...
                                <div class="photo-container">
                                    ...
                                    <div style="width: 100%; height: 150px; background-color: #f0f0f0; display: flex; align-items: center; justify-content: center; border: 1px solid #ddd; border-radius: 4px;">
                                        <span style="color: #666; font-size: 12px; text-align: center; padding: 10px;">
                                            Gambar: {{ pathinfo($path, PATHINFO_FILENAME) }}<br>
                                            (Lampiran dalam dokumen asli)
                                        </span>
                                    </div>
                                    <div class="photo-caption">{{ pathinfo($path, PATHINFO_FILENAME) }}</div>
                                </div>
                            </td>
                            @if(($index + 1) % 3 == 0)
