...
@section('pageTitle', 'Pengajuan Modifikasi Laporan')
@section('mainSection', 'Laporan LPJ')
@section('currentSection', 'Pengajuan Modifikasi Laporan')
        ...
        <div class="card">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap ms-auto">
                    ...
                    <div class="input-group position-relative" style="width: 250px;">
                        <input type="search" name="search" id="search" class="form-control"
                            placeholder="Cari pengajuan..." value="{{ request('search') }}" autocomplete="off">
            ...
            <div class="card-body position-relative">
                ...
                <div id="table-container">
                    @include('admin.laporan-lpj.pengajuan._table')
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            function updateTable(params = {}) {
                return new Promise((resolve, reject) => {
                    ...
                    const baseUrl = "{{ route('admin.laporan-lpj.pengajuan.index') }}";
