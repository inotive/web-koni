                            ...
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="jumlah_harga" id="jumlah_harga"
                                        ...
                                        value="{{ old('jumlah_harga') }}" required min="0" step="0.01">
                                    @error('jumlah_harga')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
...
@section('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const MAX_FILES = 1; // Single file for kegiatan lainnya
            ...
            function handleFileSelection(files, type) {
                ...
                if (isPhoto) {
                    selectedFotoFiles = [newFiles[0]];
                } else {
                    selectedDokumenFiles = [newFiles[0]];
                }
            ...
            function updateFilePreview(type) {
                ...
                counter.textContent = `1 file dipilih`;
                ...
                if (isPhoto) {
                    ...
                    previewHTML = `
                        <div class="file-preview-item" data-index="0">
                            <img src="${imageUrl}" alt="Preview" class="preview-image">
                            <div class="file-info">
                                <div class="file-name">${file.name}</div>
                                <div class="file-size">${fileSize}</div>
                            </div>
                            <button type="button" class="remove-file" onclick="removeFile(0, '${type}')">
