...
@section('pageTitle', 'Tambah Hubungan antar lembaga')
...
@section('currentSection', 'Tambah Hubungan antar lembaga')
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('admin.laporan-lpj.bidang.hubungan-antar-lembaga.store') }}" method="POST"
