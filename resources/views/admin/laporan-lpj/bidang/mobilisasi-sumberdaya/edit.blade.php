...
@section('content')
                                        ...
                                        @if($sumberdaya->foto_jurnal && count($sumberdaya->foto_jurnal) > 0)
                                            <div class="current-files">
                                                ...
                                                <div id="existingFotoContainer">
                                                    @foreach($sumberdaya->foto_jurnal as $index => $foto)
                                                ...
                                                <input type="hidden" name="existing_foto_jurnal" id="existingFotoInput" value="{{ json_encode($sumberdaya->foto_jurnal) }}">
                                            </div>
                                        @endif
                                        ...
                                        @if($sumberdaya->dokumen_lpj && count($sumberdaya->dokumen_lpj) > 0)
                                            <div class="current-files">
                                                ...
                                                <div id="existingDokumenContainer">
                                                    @foreach($sumberdaya->dokumen_lpj as $index => $dokumen)
                                                        @php
                                                ...
                                                <input type="hidden" name="existing_dokumen_lpj" id="existingDokumenInput" value="{{ json_encode($sumberdaya->dokumen_lpj) }}">
                                            </div>
                                        @endif
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let existingFotoFiles = @json($sumberdaya->foto_jurnal ?? []);
            let existingDokumenFiles = @json($sumberdaya->dokumen_lpj ?? []);
