...
@section('pageTitle', 'Tambah PERBAKIN - Menembak')
...
@section('currentSection', 'Tambah PERBAKIN - Menembak')
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4" style="padding: 20px 20px">
        <h3 class="fw-bold fs-2 mb-0 text-dark">Tambah Data PERBAKIN - Menembak</h3>
    </div>
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi.perbaikin.store') }}" method="POST"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateFilePreview(type) {
                ...
                files.forEach((file, index) => {
                    let filperbaikinze = (file.size / 1024).toFixed(1) + ' KB';
                    if (file.size > 1024 * 1024) {
                        filperbaikinze = (file.size / (1024 * 1024)).toFixed(1) + ' MB';
                    }
                        ...
                        previewHTML += `
                            <div class="file-preview-item" data-index="${index}">
                                ...
                                <div class="file-info">
                                    ...
                                    <div class="file-size">${filperbaikinze}</div>
                                </div>
