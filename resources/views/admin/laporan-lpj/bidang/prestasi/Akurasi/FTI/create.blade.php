            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('admin.laporan-lpj.bidang.prestasi.cabor-akurasi.fti.store') }}" method="POST"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateFilePreview(type) {
                ...
                files.forEach((file, index) => {
                    let filftize = (file.size / 1024).toFixed(1) + ' KB';
                    if (file.size > 1024 * 1024) {
                        filftize = (file.size / (1024 * 1024)).toFixed(1) + ' MB';
                    }
                        ...
                        previewHTML += `
                            <div class="file-preview-item" data-index="${index}">
                                ...
                                <div class="file-info">
                                    ...
                                    <div class="file-size">${filftize}</div>
                                </div>
