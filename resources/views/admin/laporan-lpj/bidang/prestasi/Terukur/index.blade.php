    ...
    <div class="d-grid gap-5 border-0">
        <div class="d-flex justify-content-between align-items-center container">
            <div class="d-none d-md-block">
                <h1>Cabor Terukur</h1>
                <span>Informasi Cabor Terukur untuk tahun {{ $selectedYear }}</span>
            </div>
            <form id="filter" action="{{ route('admin.laporan-lpj.bidang.prestasi.cabor-terukur') }}" method="GET" class="d-flex gap-3">
        ...
        <div id="table" class="container">
            @include('admin.laporan-lpj.bidang.prestasi.Terukur._table')
        </div>
    </div>
@endsection
