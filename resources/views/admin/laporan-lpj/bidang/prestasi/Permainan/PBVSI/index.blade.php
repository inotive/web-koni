...
@section('pageTitle', 'PBVSI - Pasir & Indoor')
...
@section('currentSection', 'PBVSI - Pasir & Indoor')
...
@section('content')
    ...
    <div class="d-flex flex-column mb-8">
        <h1 class="text-dark fw-bold mb-1">Laporan PBVSI - Pasir & Indoor</h1>
    </div>
    ...
    <div class="row col-12 mt-5">
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap py-5">
                <h3 class="card-title fw-bold fs-4 mb-0">Daftar PBVSI - Pasir & Indoor 2025</h3>
                        ...
                        <div class="dropdown-menu p-3 shadow" style="min-width: 320px;">
                            <div class="mb-3">
                                ...
                                <select id="filter-jenis-kegiatan" class="form-select">
                                    ...
                                    @foreach ($pbvsiData->pluck('nama_kegiatan')->unique()->filter() as $kegiatan)
