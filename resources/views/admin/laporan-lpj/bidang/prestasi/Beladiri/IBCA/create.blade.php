...
@section('pageTitle', 'Tambah IBCA MMA - Martial Art')
...
@section('currentSection', 'Tambah IBCA MMA - Martial Art')
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4" style="padding: 20px 20px">
        <h3 class="fw-bold fs-2 mb-0 text-dark">Tambah Data IBCA MMA - Martial Art</h3>
    </div>
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('admin.laporan-lpj.bidang.prestasi.cabor-beladiri.ibca-mma.store') }}" method="POST"
