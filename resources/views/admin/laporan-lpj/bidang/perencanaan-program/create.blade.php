...
@section('pageTitle', 'Tambah Laporan Perencanaan Program')
...
@section('currentSection', 'Tambah Laporan Perencanaan Program')
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('admin.laporan-lpj.bidang.perencanaan-program.store') }}" method="POST"
