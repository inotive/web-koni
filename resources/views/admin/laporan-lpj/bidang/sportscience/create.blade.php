...
@section('pageTitle', 'Tambah Laporan Sport Science')
...
@section('currentSection', 'Tambah Laporan Sport Science')
            ...
            <div class="row">
                <div class="card card-form">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('admin.laporan-lpj.bidang.sport-science.store') }}" method="POST"
