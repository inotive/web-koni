                                    ...
                                    <tr
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-1">
                                                {{-- PASTIKAN NAMA RUTE UNTUK AKSI INI SUDAH BENAR! --}}
                                                <a href="{{ route('admin.laporan-pj.kegiatan-lainnya.show', $kegiatan->id) }}"
                                                    class="btn btn-icon btn-sm btn-light-primary" title="Detail">
                                                    <i class="fa-solid fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.laporan-pj.kegiatan-lainnya.edit', $kegiatan->id) }}"
                                                    class="btn btn-icon btn-sm btn-light-warning" title="Edit">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>

                                                <form action="{{ route('admin.laporan-pj.kegiatan-lainnya.destroy', $kegiatan->id) }}"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form id="kt_modal_add_kegiatan_form" class="form" action="{{ route('admin.laporan-pj.kegiatan-lainnya.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#reset-filters').on('click', function() {
                    // Cukup redirect ke rute index tanpa parameter query apapun
                    window.location.href = "{{ route('admin.laporan-pj.kegiatan-lainnya.index') }}";
                });
