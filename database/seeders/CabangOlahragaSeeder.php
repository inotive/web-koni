...
class CabangOlahragaSeeder extends Seeder
{
    public function run()
    {
        $cabangOlahraga = [
            ...
            ['nama_cabor' => 'Golf', 'ketua_penanggung_jawab' => 'Sinta Dewi', 'status' => 'Pembinaan', 'tanggal_pembentukan' => '2021-11-07'],
            ...
            ['nama_cabor' => 'Bridge', 'ketua_penanggung_jawab' => 'Indira Sari', 'status' => 'Pembinaan', 'tanggal_pembentukan' => '2021-07-31'],
