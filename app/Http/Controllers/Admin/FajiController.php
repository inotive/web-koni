...
class FajiController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return view('admin.laporan-lpj.bidang.prestasi.terukur.faji._table', compact('fajiData'))->render();
        }

        return view('admin.laporan-lpj.bidang.prestasi.terukur.faji.index', compact('fajiData'));
    }

    public function create()
    {
        return view('admin.laporan-lpj.bidang.prestasi.terukur.faji.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('foto_jurnal')) {
            ...
            foreach ($request->file('foto_jurnal') as $file) {
                $fotoPaths[] = $file->store('faji/foto_jurnal', 'public');
            }
        ...
        if ($request->hasFile('dokumen_lpj')) {
            ...
            foreach ($request->file('dokumen_lpj') as $file) {
                $dokumenPaths[] = $file->store('faji/dokumen_lpj', 'public');
            }
    ...
    public function show(faji $faji)
    {
        return view('admin.laporan-lpj.bidang.prestasi.terukur.faji.show', compact('faji'));
    }

    public function edit(faji $faji)
    {
        ...
        return view('admin.laporan-lpj.bidang.prestasi.terukur.faji.edit', compact('faji'));
    }

    public function update(Request $request, faji $faji)
    {
        ...
        if ($request->hasFile('foto_jurnal')) {
            ...
            if ($faji->foto_jurnal) {
                foreach ($faji->foto_jurnal as $oldFoto) {
        ...
        if ($request->hasFile('dokumen_lpj')) {
            ...
            if ($faji->dokumen_lpj) {
                foreach ($faji->dokumen_lpj as $oldDokumen) {
    ...
    public function destroy(faji $faji)
    {
        ...
        if ($faji->foto_jurnal) {
            foreach ($faji->foto_jurnal as $foto) {
                Storage::disk('public')->delete($foto);
            }
        }

        if ($faji->dokumen_lpj) {
            foreach ($faji->dokumen_lpj as $dokumen) {
     ...
     */
    public function removeFile(Request $request, faji $faji)
    {
